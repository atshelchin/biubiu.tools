/**
 * Svelte 5 reactive task store - Tree Structure
 *
 * Provides reactive state management for task trees with automatic IndexedDB sync
 */

import { SvelteMap } from 'svelte/reactivity';
import type { Task } from './types.v2';
import * as taskManager from './task-manager.v2';
import { findTasks, getLeafTasks } from './tree-utils';
