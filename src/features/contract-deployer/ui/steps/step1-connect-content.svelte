...
<StepContent>
	<StepContentHeader
		title={i18n.t('tools.contract_deployer.step1.content.title')}
		description={i18n.t('tools.contract_deployer.step1.content.description')}
	/>
	...
	{#if isLoading}
		...
		<div class="loading-container">
			...
			<p class="loading-text">{i18n.t('tools.contract_deployer.step1.content.loading')}</p>
		</div>
	{:else}
