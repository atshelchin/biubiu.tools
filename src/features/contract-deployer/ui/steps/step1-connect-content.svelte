...
<StepContent>
	<StepContentHeader
		title={i18n.t('contract-deployer.step1.content.title')}
		description={i18n.t('contract-deployer.step1.content.description')}
	/>

	{#if isLoading}
		<LoadingState message={i18n.t('contract-deployer.step1.content.loading')} />
	{:else}
