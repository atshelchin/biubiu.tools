...
<StepContent>
	<StepContentHeader
		title={i18n.t('tools.contract_deployer.step3.content.title')}
		description={i18n.t('tools.contract_deployer.step3.content.description')}
	/>
	...
	<div class="deploy-form">
		...
		<div class="form-group">
			<label for="bytecode">
				{i18n.t('tools.contract_deployer.step3.content.bytecode_label')}
			...
			<textarea
				...
				rows={4}
			></textarea>
			<p class="help-text">{i18n.t('tools.contract_deployer.step3.content.bytecode_help')}</p>
		</div>

		<!-- ABI Input -->
		<div class="form-group">
			<label for="abi">
				{i18n.t('tools.contract_deployer.step3.content.abi_label')}
				<span class="required">*</span>
			</label>
			<textarea
				id="abi"
				...
				rows={6}
			></textarea>
			<p class="help-text">{i18n.t('tools.contract_deployer.step3.content.abi_help')}</p>
		</div>

		<!-- Constructor Args Input -->
		<div class="form-group">
			<label for="constructor-args">
				{i18n.t('tools.contract_deployer.step3.content.constructor_args_label')}
			</label>
			<textarea
				id="constructor-args"
			...
			></textarea>
			<p class="help-text">
				{i18n.t('tools.contract_deployer.step3.content.constructor_args_help')}
			</p>
		</div>
		...
		<div class="form-group">
			<label for="salt">
				{i18n.t('tools.contract_deployer.step3.content.salt_label')}
				<span class="required">*</span>
			</label>
			<div class="salt-input-group">
				...
				<button type="button" class="random-button" onclick={generateRandomSalt}>
					{i18n.t('tools.contract_deployer.step3.content.generate_random')}
				</button>
			</div>
			<p class="help-text">{i18n.t('tools.contract_deployer.step3.content.salt_help')}</p>
		</div>

		<!-- Predicted Address -->
		{#if predictedAddress}
			<div class="predicted-address">
				<h4>{i18n.t('tools.contract_deployer.step3.content.predicted_address')}</h4>
		...
		>
			{#if isDeploying}
				...
				{i18n.t('tools.contract_deployer.step3.content.deploying')}
			{:else}
				{i18n.t('tools.contract_deployer.step3.content.deploy_button')}
			{/if}
		</button>
		...
		{#if deploymentResult}
			<div class="success-box">
				<h4>{i18n.t('tools.contract_deployer.step3.content.deployment_success')}</h4>
				<div class="result-item">
					<span>{i18n.t('tools.contract_deployer.step3.content.contract_address')}:</span>
					<div class="address-display">
				...
				<div class="result-item">
					<span>{i18n.t('tools.contract_deployer.step3.content.transaction_hash')}:</span>
					<div class="address-display">
		...
		{#if deploymentError}
			<div class="error-box">
				<h4>{i18n.t('tools.contract_deployer.step3.content.deployment_error')}</h4>
				<p>{deploymentError}</p>
			</div>
		{/if}
	</div>
