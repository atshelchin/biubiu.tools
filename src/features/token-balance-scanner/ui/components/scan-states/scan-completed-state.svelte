...
<div class="completed-state">
	...
	<div class="success-banner">
		...
		<span>
			{i18n.t('tools.token_balance_scanner.step5.completed.banner', {
	...
	{#if summary && summary.tokenTotals.length > 0}
		<div class="totals-section">
			<h3>{i18n.t('tools.token_balance_scanner.step5.totals.title') || 'Total Holdings'}</h3>
					...
					<div class="total-card">
						<div class="token-header">
							...
							<span class="token-wallets">
								...
								{i18n.t('tools.token_balance_scanner.step5.totals.wallets_short') || 'wallets'}
							</span>
						</div>
