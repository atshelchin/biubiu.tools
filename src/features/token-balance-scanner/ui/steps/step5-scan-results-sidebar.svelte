...
<StepSidebar stepNumber={5} title="" description="">
	{#if status === 'scanning'}
		...
		<div class="section-box">
			<div class="section-header">
				<span class="section-title"
					>{i18n.t('routes/apps/token-balance-scanner.step5.sidebar.progress') || 'Progress'}</span
				>
			...
			<div class="progress-stats">
				<span class="stat-item">
					...
					<span class="stat-label"
						>{i18n.t('routes/apps/token-balance-scanner.step5.sidebar.completed') ||
							'completed'}</span
					>
				</span>
				...
				<span class="stat-item">
					...
					<span class="stat-label"
						>{i18n.t('routes/apps/token-balance-scanner.step5.sidebar.total') || 'total'}</span
					>
				</span>
			</div>
			{#if progress.failed && progress.failed > 0}
				<div class="failed-notice">
					...
					<span
						>{progress.failed}
						{i18n.t('routes/apps/token-balance-scanner.step5.sidebar.queries_failed') ||
							'queries failed'}</span
					>
				</div>
			{/if}
		...
		<div class="logs-section">
			<button class="logs-toggle" onclick={() => (logsExpanded = !logsExpanded)}>
				<Terminal size={14} />
				<span>{i18n.t('routes/apps/token-balance-scanner.step5.sidebar.logs') || 'Live Logs'}</span>
				{#if logsExpanded}
					<ChevronUp size={14} />
				{:else}
					<ChevronDown size={14} />
	...
	{:else if status === 'paused'}
		...
		<div class="section-box">
			<div class="section-header">
				<span class="section-title"
					>{i18n.t('routes/apps/token-balance-scanner.step5.sidebar.paused') || 'Paused'}</span
				>
			</div>
			<div class="stats-row">
				...
				<div class="stat-block">
					...
					<span class="stat-label"
						>{i18n.t('routes/apps/token-balance-scanner.step5.sidebar.remaining') ||
							'Remaining'}</span
					>
				</div>
			</div>
	...
	{:else if status === 'completed' && summary}
		...
		<div class="section-box">
			<div class="section-header">
				<span class="section-title"
					>{i18n.t('routes/apps/token-balance-scanner.step5.sidebar.scan_results') ||
						'Scan Results'}</span
				>
			</div>
			<div class="result-list">
				<div class="result-item">
					...
					<span class="result-label"
						>{i18n.t('routes/apps/token-balance-scanner.step5.sidebar.addresses_scanned') ||
				...
				<div class="result-item highlight">
					...
					<span class="result-label"
						>{i18n.t('routes/apps/token-balance-scanner.step5.sidebar.with_balance') ||
		...
		<div class="section-box">
			<div class="section-header">
				<span class="section-title"
					>{i18n.t('routes/apps/token-balance-scanner.step5.sidebar.export') || 'Export'}</span
				>
			</div>
		...
		<button class="new-scan-btn" onclick={handleNewScan}>
			<RefreshCw size={16} />
			<span
				>{i18n.t('routes/apps/token-balance-scanner.step5.sidebar.new_scan') ||
					'Start New Scan'}</span
			>
		</button>
	{:else}
		...
		<div class="section-box">
			<div class="section-header">
				<span class="section-title"
					>{i18n.t('routes/apps/token-balance-scanner.step5.sidebar.ready') ||
						'Ready to Scan'}</span
				>
			</div>
			<div class="result-list">
				<div class="result-item">
					...
					<span class="result-label"
						>{i18n.t('routes/apps/token-balance-scanner.step5.sidebar.wallets') || 'wallets'}</span
					>
				</div>
				<div class="result-item">
					<span class="result-value">{step3State.selectedTokens.size}</span>
					<span class="result-label"
						>{i18n.t('routes/apps/token-balance-scanner.step5.sidebar.tokens') || 'tokens'}</span
					>
				</div>
			</div>
		</div>
	...
	<div class="info-box">
		<h4>
			{i18n.t('routes/apps/token-balance-scanner.step5.sidebar.info_title') || "What's Happening?"}
		</h4>
		<ul class="info-list">
			<li>
				{i18n.t('routes/apps/token-balance-scanner.step5.sidebar.info_1') ||
					'Querying blockchain for token balances'}
			</li>
			<li>
				{i18n.t('routes/apps/token-balance-scanner.step5.sidebar.info_2') ||
					'Using multiple RPCs in parallel'}
			</li>
			<li>
				{i18n.t('routes/apps/token-balance-scanner.step5.sidebar.info_3') ||
	...
	{#if status === 'completed'}
		<div class="tip-box">
			<p>
				{i18n.t('routes/apps/token-balance-scanner.step5.sidebar.tip_completed') ||
	...
	{:else if status === 'scanning'}
		<div class="tip-box">
			<p>
				{i18n.t('routes/apps/token-balance-scanner.step5.sidebar.tip_scanning') ||
	...
	{:else}
		<div class="tip-box">
			<p>
				{i18n.t('routes/apps/token-balance-scanner.step5.sidebar.tip_idle') ||
