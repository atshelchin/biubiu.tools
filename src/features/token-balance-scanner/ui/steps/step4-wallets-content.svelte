	...
	const importMethodOptions = $derived([
		{
			...
			label: i18n.t('routes/apps/token-balance-scanner.step4.import_method.address') || 'Addresses'
		},
		{
			value: 'xpub' as const,
			label:
				i18n.t('routes/apps/token-balance-scanner.step4.import_method.xpub') ||
				'Extended Public Key'
		}
	]);
...
<StepContent>
	<StepContentHeader
		title={i18n.t('routes/apps/token-balance-scanner.step4.content.title') ||
			'Import Wallet Addresses'}
		description={i18n.t('routes/apps/token-balance-scanner.step4.content.description') ||
	...
	<div>
		<div class="form-label">
			{i18n.t('routes/apps/token-balance-scanner.step4.content.choose_method') ||
	...
	{#if importMethod === 'address'}
		<AddressTextImport
			...
			placeholder={i18n.t('routes/apps/token-balance-scanner.step4.content.address_placeholder') ||
	...
	{#if walletCount > 0}
		<div class="form-section">
			<div class="wallet-list-header">
				<div class="form-label">
					{i18n.t('routes/apps/token-balance-scanner.step4.content.wallet_list.title') || 'Wallets'}
					<span class="wallet-count">
						{i18n.t('routes/apps/token-balance-scanner.step4.content.wallet_list.count', {
							count: walletCount
						}) || `(${walletCount})`}
					</span>
				</div>
				<button class="btn-text-danger" onclick={handleClearAll}>
					{i18n.t('routes/apps/token-balance-scanner.step4.content.wallet_list.clear_all') ||
						'Clear All'}
				</button>
			</div>
			...
			<WalletList
				...
				emptyMessage={i18n.t('routes/apps/token-balance-scanner.step4.content.wallet_list.empty') ||
...
<ConfirmDialog
	...
	title={i18n.t('routes/apps/token-balance-scanner.step4.dialogs.remove_wallet_title') ||
		'Remove Wallet'}
	message={i18n.t('routes/apps/token-balance-scanner.step4.dialogs.remove_wallet_message', {
		address: walletToRemove
	}) || `Are you sure you want to remove this wallet?\n${walletToRemove}`}
	confirmText={i18n.t('routes/apps/token-balance-scanner.step4.dialogs.remove_button') || 'Remove'}
	cancelText={i18n.t('routes/apps/token-balance-scanner.step4.dialogs.cancel_button') || 'Cancel'}
	variant="danger"
...
<ConfirmDialog
	...
	title={i18n.t('routes/apps/token-balance-scanner.step4.dialogs.clear_all_title') ||
		'Clear All Wallets'}
	message={i18n.t('routes/apps/token-balance-scanner.step4.dialogs.clear_all_message', {
		count: walletCount
	}) || `Are you sure you want to remove all ${walletCount} wallets?`}
	confirmText={i18n.t('routes/apps/token-balance-scanner.step4.dialogs.clear_all_button') ||
		'Clear All'}
	confirmHint={i18n.t('routes/apps/token-balance-scanner.step4.dialogs.long_press_hint') ||
		'Hold to confirm'}
	cancelText={i18n.t('routes/apps/token-balance-scanner.step4.dialogs.cancel_button') || 'Cancel'}
	variant="danger"
