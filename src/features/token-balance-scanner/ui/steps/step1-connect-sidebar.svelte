...
<StepSidebar
	...
	description="Connect your Web3 wallet to scan token balances"
>
	<div class="feature-highlights">
		<ul class="feature-list">
			<li>
				<span class="feature-icon">🔍</span>
				<span>Scan balances across multiple wallets</span>
			</li>
			<li>
				<span class="feature-icon">📊</span>
				<span>View aggregated statistics and totals</span>
			</li>
			<li>
				<span class="feature-icon">📤</span>
