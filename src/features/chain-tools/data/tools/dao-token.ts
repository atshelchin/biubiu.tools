...
export const daoTokenTools: ExternalTool[] = [
	// ========== Major DeFi Governance Tokens ==========
	{
		id: 'uni-token',
		name: 'UNI (Uniswap)',
		descriptionKey: 'chain-tools.tools.uni_token.description',
	...
	},
	{
		id: 'aave-token',
		name: 'AAVE (Aave)',
		descriptionKey: 'chain-tools.tools.aave_token.description',
	...
	},
	{
		id: 'mkr-token',
		name: 'MKR (MakerDAO)',
		descriptionKey: 'chain-tools.tools.mkr_token.description',
	...
	},
	{
		id: 'crv-token',
		name: 'CRV (Curve)',
		descriptionKey: 'chain-tools.tools.crv_token.description',
	...
	},
	{
		id: 'comp-token',
		name: 'COMP (Compound)',
		descriptionKey: 'chain-tools.tools.comp_token.description',
	...
	},
	{
		id: 'snx-token',
		name: 'SNX (Synthetix)',
		descriptionKey: 'chain-tools.tools.snx_token.description',
	...
	},
	{
		id: 'ldo-token',
		name: 'LDO (Lido)',
		descriptionKey: 'chain-tools.tools.ldo_token.description',
	...
	},
	{
		id: 'gmx-token',
		name: 'GMX (GMX)',
		descriptionKey: 'chain-tools.tools.gmx_token.description',
	...
	},
	{
		id: 'bal-token',
		name: 'BAL (Balancer)',
		descriptionKey: 'chain-tools.tools.bal_token.description',
	...
	},
	{
		...
		descriptionKey: 'chain-tools.tools.sushi_token.description',
	...
	},
	{
		id: 'yfi-token',
		name: 'YFI (Yearn)',
		descriptionKey: 'chain-tools.tools.yfi_token.description',
	...
	},
	{
		id: 'inch-token',
		name: '1INCH (1inch)',
		descriptionKey: 'chain-tools.tools.inch_token.description',
	...
	},
	{
		id: 'pendle-token',
		name: 'PENDLE (Pendle)',
		descriptionKey: 'chain-tools.tools.pendle_token.description',
	...
	},
	{
		id: 'ena-token',
		name: 'ENA (Ethena)',
		descriptionKey: 'chain-tools.tools.ena_token.description',
	...
	},
	{
		id: 'dydx-token',
		name: 'DYDX (dYdX)',
		descriptionKey: 'chain-tools.tools.dydx_token.description',
	...
	},
	{
		id: 'cvx-token',
		name: 'CVX (Convex)',
		descriptionKey: 'chain-tools.tools.cvx_token.description',
	...
	},
	{
		id: 'fxs-token',
		name: 'FXS (Frax)',
		descriptionKey: 'chain-tools.tools.fxs_token.description',
	...
	},
	{
		id: 'blur-token',
		name: 'BLUR (Blur)',
		descriptionKey: 'chain-tools.tools.blur_token.description',
		url: 'https://blur.io',
		icon: Zap,
		category: 'dao-token',
	...
	},
	{
		id: 'ape-token',
		name: 'APE (ApeCoin)',
		descriptionKey: 'chain-tools.tools.ape_token.description',
	...
	},
	{
		...
		descriptionKey: 'chain-tools.tools.rpl_token.description',
	...
	},
	{
		id: 'morpho-token',
		name: 'MORPHO (Morpho)',
		descriptionKey: 'chain-tools.tools.morpho_token.description',
	...
	},
	{
		id: 'rdnt-token',
		name: 'RDNT (Radiant)',
		descriptionKey: 'chain-tools.tools.rdnt_token.description',
	...
	},
	{
		id: 'osmo-token',
		name: 'OSMO (Osmosis)',
		descriptionKey: 'chain-tools.tools.osmo_token.description',
	...
	},
	{
		id: 'jup-token',
		name: 'JUP (Jupiter)',
		descriptionKey: 'chain-tools.tools.jup_token.description',
	...
	},
	{
		id: 'ray-token',
		name: 'RAY (Raydium)',
		descriptionKey: 'chain-tools.tools.ray_token.description',
	...
	},
	{
		id: 'jto-token',
		name: 'JTO (Jito)',
		descriptionKey: 'chain-tools.tools.jto_token.description',
	...
	},
	{
		id: 'orca-token',
		name: 'ORCA (Orca)',
		descriptionKey: 'chain-tools.tools.orca_token.description',
	...
	// ========== L2 & Infrastructure Governance ==========
	{
		id: 'arb-token',
		name: 'ARB (Arbitrum)',
		descriptionKey: 'chain-tools.tools.arb_token.description',
	...
	},
	{
		id: 'op-token',
		name: 'OP (Optimism)',
		descriptionKey: 'chain-tools.tools.op_token.description',
	...
	},
	{
		id: 'strk-token',
		name: 'STRK (StarkNet)',
		descriptionKey: 'chain-tools.tools.strk_token.description',
	...
	},
	{
		id: 'zk-token',
		name: 'ZK (zkSync)',
		descriptionKey: 'chain-tools.tools.zk_token.description',
	...
	},
	{
		...
		descriptionKey: 'chain-tools.tools.matic_token.description',
	...
	},
	{
		id: 'mnt-token',
		name: 'MNT (Mantle)',
		descriptionKey: 'chain-tools.tools.mnt_token.description',
	...
	},
	{
		id: 'metis-token',
		name: 'METIS (Metis)',
		descriptionKey: 'chain-tools.tools.metis_token.description',
		url: 'https://metis.io',
		icon: Layers,
		category: 'dao-token',
	...
	// ========== DAO Infrastructure Tokens ==========
	{
		...
		descriptionKey: 'chain-tools.tools.ens_token.description',
	...
	},
	{
		id: 'gtc-token',
		name: 'GTC (Gitcoin)',
		descriptionKey: 'chain-tools.tools.gtc_token.description',
	...
	},
	{
		id: 'safe-token',
		name: 'SAFE (Safe)',
		descriptionKey: 'chain-tools.tools.safe_token.description',
	...
	},
	{
		...
		descriptionKey: 'chain-tools.tools.cow_token.description',
	...
	},
	{
		id: 'gno-token',
		name: 'GNO (Gnosis)',
		descriptionKey: 'chain-tools.tools.gno_token.description',
	...
	// ========== Governance Platforms ==========
	{
		id: 'tally-governance',
		name: 'Tally',
		descriptionKey: 'chain-tools.tools.tally_governance.description',
	...
	},
	{
		...
		name: 'Snapshot',
		descriptionKey: 'chain-tools.tools.snapshot_governance.description',
	...
	},
	{
		id: 'karma-dao',
		name: 'Karma',
		descriptionKey: 'chain-tools.tools.karma_dao.description',
	...
	},
	{
		...
		descriptionKey: 'chain-tools.tools.messari_governance.description',
