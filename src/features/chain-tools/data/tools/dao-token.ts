...
export const daoTokenTools: ExternalTool[] = [
	// ========== Major DeFi Governance Tokens ==========
	{
		id: 'uni-token',
		name: 'UNI (Uniswap)',
		descriptionKey: 'chain-tools.dao_token.tools.uni_token.description',
	...
	},
	{
		id: 'aave-token',
		name: 'AAVE (Aave)',
		descriptionKey: 'chain-tools.dao_token.tools.aave_token.description',
	...
	},
	{
		id: 'mkr-token',
		name: 'MKR (MakerDAO)',
		descriptionKey: 'chain-tools.dao_token.tools.mkr_token.description',
	...
	},
	{
		id: 'crv-token',
		name: 'CRV (Curve)',
		descriptionKey: 'chain-tools.dao_token.tools.crv_token.description',
	...
	},
	{
		id: 'comp-token',
		name: 'COMP (Compound)',
		descriptionKey: 'chain-tools.dao_token.tools.comp_token.description',
	...
	},
	{
		id: 'snx-token',
		name: 'SNX (Synthetix)',
		descriptionKey: 'chain-tools.dao_token.tools.snx_token.description',
	...
	},
	{
		id: 'ldo-token',
		name: 'LDO (Lido)',
		descriptionKey: 'chain-tools.dao_token.tools.ldo_token.description',
	...
	},
	{
		id: 'gmx-token',
		name: 'GMX (GMX)',
		descriptionKey: 'chain-tools.dao_token.tools.gmx_token.description',
	...
	},
	{
		id: 'bal-token',
		name: 'BAL (Balancer)',
		descriptionKey: 'chain-tools.dao_token.tools.bal_token.description',
	...
	},
	{
		...
		descriptionKey: 'chain-tools.dao_token.tools.sushi_token.description',
	...
	},
	{
		id: 'yfi-token',
		name: 'YFI (Yearn)',
		descriptionKey: 'chain-tools.dao_token.tools.yfi_token.description',
	...
	},
	{
		id: 'inch-token',
		name: '1INCH (1inch)',
		descriptionKey: 'chain-tools.dao_token.tools.inch_token.description',
	...
	},
	{
		id: 'pendle-token',
		name: 'PENDLE (Pendle)',
		descriptionKey: 'chain-tools.dao_token.tools.pendle_token.description',
	...
	},
	{
		id: 'ena-token',
		name: 'ENA (Ethena)',
		descriptionKey: 'chain-tools.dao_token.tools.ena_token.description',
	...
	},
	{
		id: 'dydx-token',
		name: 'DYDX (dYdX)',
		descriptionKey: 'chain-tools.dao_token.tools.dydx_token.description',
	...
	},
	{
		id: 'cvx-token',
		name: 'CVX (Convex)',
		descriptionKey: 'chain-tools.dao_token.tools.cvx_token.description',
	...
	},
	{
		id: 'fxs-token',
		name: 'FXS (Frax)',
		descriptionKey: 'chain-tools.dao_token.tools.fxs_token.description',
	...
	},
	{
		id: 'blur-token',
		name: 'BLUR (Blur)',
		descriptionKey: 'chain-tools.dao_token.tools.blur_token.description',
		url: 'https://blur.io',
		icon: Zap,
		category: 'dao-token',
	...
	},
	{
		id: 'ape-token',
		name: 'APE (ApeCoin)',
		descriptionKey: 'chain-tools.dao_token.tools.ape_token.description',
	...
	},
	{
		...
		descriptionKey: 'chain-tools.dao_token.tools.rpl_token.description',
	...
	},
	{
		id: 'morpho-token',
		name: 'MORPHO (Morpho)',
		descriptionKey: 'chain-tools.dao_token.tools.morpho_token.description',
	...
	},
	{
		id: 'rdnt-token',
		name: 'RDNT (Radiant)',
		descriptionKey: 'chain-tools.dao_token.tools.rdnt_token.description',
	...
	},
	{
		id: 'osmo-token',
		name: 'OSMO (Osmosis)',
		descriptionKey: 'chain-tools.dao_token.tools.osmo_token.description',
	...
	},
	{
		id: 'jup-token',
		name: 'JUP (Jupiter)',
		descriptionKey: 'chain-tools.dao_token.tools.jup_token.description',
	...
	},
	{
		id: 'ray-token',
		name: 'RAY (Raydium)',
		descriptionKey: 'chain-tools.dao_token.tools.ray_token.description',
	...
	},
	{
		id: 'jto-token',
		name: 'JTO (Jito)',
		descriptionKey: 'chain-tools.dao_token.tools.jto_token.description',
	...
	},
	{
		id: 'orca-token',
		name: 'ORCA (Orca)',
		descriptionKey: 'chain-tools.dao_token.tools.orca_token.description',
	...
	// ========== L2 & Infrastructure Governance ==========
	{
		id: 'arb-token',
		name: 'ARB (Arbitrum)',
		descriptionKey: 'chain-tools.dao_token.tools.arb_token.description',
	...
	},
	{
		id: 'op-token',
		name: 'OP (Optimism)',
		descriptionKey: 'chain-tools.dao_token.tools.op_token.description',
	...
	},
	{
		id: 'strk-token',
		name: 'STRK (StarkNet)',
		descriptionKey: 'chain-tools.dao_token.tools.strk_token.description',
	...
	},
	{
		id: 'zk-token',
		name: 'ZK (zkSync)',
		descriptionKey: 'chain-tools.dao_token.tools.zk_token.description',
	...
	},
	{
		...
		descriptionKey: 'chain-tools.dao_token.tools.matic_token.description',
	...
	},
	{
		id: 'mnt-token',
		name: 'MNT (Mantle)',
		descriptionKey: 'chain-tools.dao_token.tools.mnt_token.description',
	...
	},
	{
		id: 'metis-token',
		name: 'METIS (Metis)',
		descriptionKey: 'chain-tools.dao_token.tools.metis_token.description',
		url: 'https://metis.io',
		icon: Layers,
		category: 'dao-token',
	...
	// ========== DAO Infrastructure Tokens ==========
	{
		...
		descriptionKey: 'chain-tools.dao_token.tools.ens_token.description',
	...
	},
	{
		id: 'gtc-token',
		name: 'GTC (Gitcoin)',
		descriptionKey: 'chain-tools.dao_token.tools.gtc_token.description',
	...
	},
	{
		id: 'safe-token',
		name: 'SAFE (Safe)',
		descriptionKey: 'chain-tools.dao_token.tools.safe_token.description',
	...
	},
	{
		...
		descriptionKey: 'chain-tools.dao_token.tools.cow_token.description',
	...
	},
	{
		id: 'gno-token',
		name: 'GNO (Gnosis)',
		descriptionKey: 'chain-tools.dao_token.tools.gno_token.description',
	...
	// ========== Governance Platforms ==========
	{
		id: 'tally-governance',
		name: 'Tally',
		descriptionKey: 'chain-tools.dao_token.tools.tally_governance.description',
	...
	},
	{
		...
		name: 'Snapshot',
		descriptionKey: 'chain-tools.dao_token.tools.snapshot_governance.description',
	...
	},
	{
		id: 'boardroom',
		name: 'Boardroom',
		descriptionKey: 'chain-tools.dao_token.tools.boardroom.description',
	...
	},
	{
		id: 'karma-dao',
		name: 'Karma',
		descriptionKey: 'chain-tools.dao_token.tools.karma_dao.description',
	...
	},
	{
		...
		descriptionKey: 'chain-tools.dao_token.tools.messari_governance.description',
