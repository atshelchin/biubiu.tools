...
export const stablecoinTools: ExternalTool[] = [
	// ========== Major USD Stablecoins ==========
	{
		id: 'usdt-tether',
		name: 'Tether (USDT)',
		descriptionKey: 'chain-tools.stablecoin.tools.usdt_tether.description',
		url: 'https://tether.to',
	...
	},
	{
		id: 'usdc-circle',
		name: 'USD Coin (USDC)',
		descriptionKey: 'chain-tools.stablecoin.tools.usdc_circle.description',
	...
	},
	{
		id: 'dai-makerdao',
		name: 'DAI (MakerDAO)',
		descriptionKey: 'chain-tools.stablecoin.tools.dai_makerdao.description',
	...
	},
	{
		id: 'frax',
		name: 'Frax (FRAX)',
		descriptionKey: 'chain-tools.stablecoin.tools.frax.description',
	...
	},
	{
		id: 'usde-ethena',
		name: 'USDe (Ethena)',
		descriptionKey: 'chain-tools.stablecoin.tools.usde_ethena.description',
		url: 'https://ethena.fi',
		icon: TrendingUp,
		category: 'stablecoin',
	...
	},
	{
		id: 'usdd-tron',
		name: 'USDD (Tron)',
		descriptionKey: 'chain-tools.stablecoin.tools.usdd_tron.description',
		url: 'https://usdd.io',
		icon: CircleDollarSign,
		category: 'stablecoin',
	...
	},
	{
		id: 'tusd',
		name: 'TrueUSD (TUSD)',
		descriptionKey: 'chain-tools.stablecoin.tools.tusd.description',
	...
	},
	{
		...
		descriptionKey: 'chain-tools.stablecoin.tools.busd_paxos.description',
	...
	},
	{
		...
		descriptionKey: 'chain-tools.stablecoin.tools.pyusd_paypal.description',
	...
	},
	{
		...
		descriptionKey: 'chain-tools.stablecoin.tools.gusd_gemini.description',
	...
	},
	{
		...
		descriptionKey: 'chain-tools.stablecoin.tools.usdp_paxos.description',
	...
	// ========== Yield-Bearing Stablecoins ==========
	{
		id: 'sdai-spark',
		name: 'sDAI (Spark)',
		descriptionKey: 'chain-tools.stablecoin.tools.sdai_spark.description',
		url: 'https://spark.fi',
		icon: Percent,
		category: 'stablecoin',
	...
	},
	{
		id: 'susde-ethena',
		name: 'sUSDe (Ethena)',
		descriptionKey: 'chain-tools.stablecoin.tools.susde_ethena.description',
		url: 'https://ethena.fi',
		icon: Percent,
		category: 'stablecoin',
	...
	},
	{
		id: 'sfrax',
		name: 'sFRAX (Frax)',
		descriptionKey: 'chain-tools.stablecoin.tools.sfrax.description',
	...
	// ========== Euro & Other Currency Stablecoins ==========
	{
		...
		descriptionKey: 'chain-tools.stablecoin.tools.eurs_stasis.description',
	...
	},
	{
		id: 'eurc-circle',
		name: 'Euro Coin (EURC)',
		descriptionKey: 'chain-tools.stablecoin.tools.eurc_circle.description',
	...
	},
	{
		id: 'eurt-tether',
		name: 'Tether EURt',
		descriptionKey: 'chain-tools.stablecoin.tools.eurt_tether.description',
	...
	},
	{
		id: 'xsgd-straitsx',
		name: 'XSGD (StraitsX)',
		descriptionKey: 'chain-tools.stablecoin.tools.xsgd_straitsx.description',
	...
	// ========== Decentralized Stablecoins ==========
	{
		id: 'lusd-liquity',
		name: 'LUSD (Liquity)',
		descriptionKey: 'chain-tools.stablecoin.tools.lusd_liquity.description',
	...
	},
	{
		id: 'susd-synthetix',
		name: 'sUSD (Synthetix)',
		descriptionKey: 'chain-tools.stablecoin.tools.susd_synthetix.description',
	...
	},
	{
		id: 'rai-reflexer',
		name: 'RAI (Reflexer)',
		descriptionKey: 'chain-tools.stablecoin.tools.rai_reflexer.description',
	...
	},
	{
		...
		descriptionKey: 'chain-tools.stablecoin.tools.mim_abracadabra.description',
	...
	},
	{
		id: 'crvusd-curve',
		name: 'crvUSD (Curve)',
		descriptionKey: 'chain-tools.stablecoin.tools.crvusd_curve.description',
	...
	},
	{
		id: 'gho-aave',
		name: 'GHO (Aave)',
		descriptionKey: 'chain-tools.stablecoin.tools.gho_aave.description',
	...
	// ========== Stablecoin Aggregators & Tools ==========
	{
		...
		descriptionKey: 'chain-tools.stablecoin.tools.defillama_stablecoins.description',
	...
	},
	{
		...
		descriptionKey: 'chain-tools.stablecoin.tools.coingecko_stablecoins.description',
	...
	// ========== Additional Stablecoins ==========
	{
		...
		descriptionKey: 'chain-tools.stablecoin.tools.fdusd.description',
	...
	},
	{
		id: 'usual-usd0',
		name: 'USD0 (Usual)',
		descriptionKey: 'chain-tools.stablecoin.tools.usual_usd0.description',
	...
	},
	{
		id: 'mountain-usdm',
		name: 'USDM (Mountain)',
		descriptionKey: 'chain-tools.stablecoin.tools.mountain_usdm.description',
	...
	},
	{
		id: 'ageur-angle',
		name: 'EURA (Angle)',
		descriptionKey: 'chain-tools.stablecoin.tools.ageur_angle.description',
	...
	},
	{
		id: 'mkusd-prisma',
		name: 'mkUSD (Prisma)',
		descriptionKey: 'chain-tools.stablecoin.tools.mkusd_prisma.description',
	...
	},
	{
		id: 'ultra-usd',
		name: 'Ultra USDu',
		descriptionKey: 'chain-tools.stablecoin.tools.ultra_usd.description',
	...
	},
	{
		id: 'dola-inverse',
		name: 'DOLA (Inverse)',
		descriptionKey: 'chain-tools.stablecoin.tools.dola_inverse.description',
	...
	},
	{
		...
		descriptionKey: 'chain-tools.stablecoin.tools.hai_reflexer.description',
	...
	},
	{
		id: 'usdk-okx',
		name: 'USDK (OKX)',
		descriptionKey: 'chain-tools.stablecoin.tools.usdk_okx.description',
	...
	},
	{
		id: 'zusd-zeta',
		name: 'ZUSD (Zeta)',
		descriptionKey: 'chain-tools.stablecoin.tools.zusd_zeta.description',
	...
	},
	{
		id: 'bob-stablecoin',
		name: 'BOB',
		descriptionKey: 'chain-tools.stablecoin.tools.bob_stablecoin.description',
		url: 'https://bob.money',
		icon: Coins,
		category: 'stablecoin',
	...
	},
	{
		id: 'usdx-kava',
		name: 'USDX (Kava)',
		descriptionKey: 'chain-tools.stablecoin.tools.usdx_kava.description',
		url: 'https://kava.io',
		icon: Coins,
		category: 'stablecoin',
	...
	},
	{
		id: 'isc-interest',
		name: 'ISC (Interest)',
		descriptionKey: 'chain-tools.stablecoin.tools.isc_interest.description',
	...
	},
	{
		id: 'cusd-celo',
		name: 'cUSD (Celo)',
		descriptionKey: 'chain-tools.stablecoin.tools.cusd_celo.description',
		url: 'https://celo.org',
		icon: CircleDollarSign,
		category: 'stablecoin',
	...
	},
	{
		id: 'ceur-celo',
		name: 'cEUR (Celo)',
		descriptionKey: 'chain-tools.stablecoin.tools.ceur_celo.description',
		url: 'https://celo.org',
		icon: Globe,
		category: 'stablecoin',
	...
	},
	{
		id: 'flexusd',
		name: 'flexUSD',
		descriptionKey: 'chain-tools.stablecoin.tools.flexusd.description',
	...
	},
	{
		id: 'alusd-alchemix',
		name: 'alUSD (Alchemix)',
		descriptionKey: 'chain-tools.stablecoin.tools.alusd_alchemix.description',
	...
	},
	{
		id: 'usd-plus',
		name: 'USD+ (Overnight)',
		descriptionKey: 'chain-tools.stablecoin.tools.usd_plus.description',
	...
	},
	{
		id: 'ust-wormhole',
		name: 'UST (Wormhole)',
		descriptionKey: 'chain-tools.stablecoin.tools.ust_wormhole.description',
