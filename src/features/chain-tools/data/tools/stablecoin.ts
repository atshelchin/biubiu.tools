...
export const stablecoinTools: ExternalTool[] = [
	// ========== Major USD Stablecoins ==========
	{
		id: 'usdt-tether',
		name: 'Tether (USDT)',
		descriptionKey: 'chain-tools.tools.usdt_tether.description',
		url: 'https://tether.to',
	...
	},
	{
		id: 'usdc-circle',
		name: 'USD Coin (USDC)',
		descriptionKey: 'chain-tools.tools.usdc_circle.description',
	...
	},
	{
		id: 'dai-makerdao',
		name: 'DAI (MakerDAO)',
		descriptionKey: 'chain-tools.tools.dai_makerdao.description',
	...
	},
	{
		id: 'usde-ethena',
		name: 'USDe (Ethena)',
		descriptionKey: 'chain-tools.tools.usde_ethena.description',
		url: 'https://ethena.fi',
		icon: TrendingUp,
		category: 'stablecoin',
	...
	},
	{
		id: 'usdd-tron',
		name: 'USDD (Tron)',
		descriptionKey: 'chain-tools.tools.usdd_tron.description',
		url: 'https://usdd.io',
		icon: CircleDollarSign,
		category: 'stablecoin',
	...
	},
	{
		id: 'tusd',
		name: 'TrueUSD (TUSD)',
		descriptionKey: 'chain-tools.tools.tusd.description',
	...
	},
	{
		...
		descriptionKey: 'chain-tools.tools.busd_paxos.description',
	...
	},
	{
		...
		descriptionKey: 'chain-tools.tools.pyusd_paypal.description',
	...
	},
	{
		...
		descriptionKey: 'chain-tools.tools.gusd_gemini.description',
	...
	},
	{
		...
		descriptionKey: 'chain-tools.tools.usdp_paxos.description',
	...
	// ========== Yield-Bearing Stablecoins ==========
	{
		id: 'sdai-spark',
		name: 'sDAI (Spark)',
		descriptionKey: 'chain-tools.tools.sdai_spark.description',
		url: 'https://spark.fi',
		icon: Percent,
		category: 'stablecoin',
	...
	},
	{
		id: 'susde-ethena',
		name: 'sUSDe (Ethena)',
		descriptionKey: 'chain-tools.tools.susde_ethena.description',
		url: 'https://ethena.fi',
		icon: Percent,
		category: 'stablecoin',
	...
	},
	{
		id: 'sfrax',
		name: 'sFRAX (Frax)',
		descriptionKey: 'chain-tools.tools.sfrax.description',
	...
	// ========== Euro & Other Currency Stablecoins ==========
	{
		...
		descriptionKey: 'chain-tools.tools.eurs_stasis.description',
	...
	},
	{
		id: 'eurc-circle',
		name: 'Euro Coin (EURC)',
		descriptionKey: 'chain-tools.tools.eurc_circle.description',
	...
	},
	{
		id: 'eurt-tether',
		name: 'Tether EURt',
		descriptionKey: 'chain-tools.tools.eurt_tether.description',
	...
	},
	{
		id: 'xsgd-straitsx',
		name: 'XSGD (StraitsX)',
		descriptionKey: 'chain-tools.tools.xsgd_straitsx.description',
	...
	// ========== Decentralized Stablecoins ==========
	{
		id: 'lusd-liquity',
		name: 'LUSD (Liquity)',
		descriptionKey: 'chain-tools.tools.lusd_liquity.description',
	...
	},
	{
		id: 'susd-synthetix',
		name: 'sUSD (Synthetix)',
		descriptionKey: 'chain-tools.tools.susd_synthetix.description',
	...
	},
	{
		id: 'rai-reflexer',
		name: 'RAI (Reflexer)',
		descriptionKey: 'chain-tools.tools.rai_reflexer.description',
	...
	},
	{
		...
		descriptionKey: 'chain-tools.tools.mim_abracadabra.description',
	...
	},
	{
		id: 'crvusd-curve',
		name: 'crvUSD (Curve)',
		descriptionKey: 'chain-tools.tools.crvusd_curve.description',
	...
	},
	{
		id: 'gho-aave',
		name: 'GHO (Aave)',
		descriptionKey: 'chain-tools.tools.gho_aave.description',
	...
	// ========== Stablecoin Aggregators & Tools ==========
	{
		...
		descriptionKey: 'chain-tools.tools.defillama_stablecoins.description',
	...
	},
	{
		...
		descriptionKey: 'chain-tools.tools.coingecko_stablecoins.description',
	...
	// ========== Additional Stablecoins ==========
	{
		...
		descriptionKey: 'chain-tools.tools.fdusd.description',
	...
	},
	{
		id: 'usual-usd0',
		name: 'USD0 (Usual)',
		descriptionKey: 'chain-tools.tools.usual_usd0.description',
	...
	},
	{
		id: 'mountain-usdm',
		name: 'USDM (Mountain)',
		descriptionKey: 'chain-tools.tools.mountain_usdm.description',
	...
	},
	{
		id: 'ageur-angle',
		name: 'EURA (Angle)',
		descriptionKey: 'chain-tools.tools.ageur_angle.description',
	...
	},
	{
		id: 'mkusd-prisma',
		name: 'mkUSD (Prisma)',
		descriptionKey: 'chain-tools.tools.mkusd_prisma.description',
	...
	},
	{
		id: 'ultra-usd',
		name: 'Ultra USDu',
		descriptionKey: 'chain-tools.tools.ultra_usd.description',
	...
	},
	{
		id: 'dola-inverse',
		name: 'DOLA (Inverse)',
		descriptionKey: 'chain-tools.tools.dola_inverse.description',
	...
	},
	{
		...
		descriptionKey: 'chain-tools.tools.hai_reflexer.description',
	...
	},
	{
		id: 'usdk-okx',
		name: 'USDK (OKX)',
		descriptionKey: 'chain-tools.tools.usdk_okx.description',
	...
	},
	{
		id: 'zusd-zeta',
		name: 'ZUSD (Zeta)',
		descriptionKey: 'chain-tools.tools.zusd_zeta.description',
	...
	},
	{
		id: 'bob-stablecoin',
		name: 'BOB',
		descriptionKey: 'chain-tools.tools.bob_stablecoin.description',
		url: 'https://bob.money',
		icon: Coins,
		category: 'stablecoin',
	...
	},
	{
		id: 'usdx-kava',
		name: 'USDX (Kava)',
		descriptionKey: 'chain-tools.tools.usdx_kava.description',
		url: 'https://kava.io',
		icon: Coins,
		category: 'stablecoin',
	...
	},
	{
		id: 'isc-interest',
		name: 'ISC (Interest)',
		descriptionKey: 'chain-tools.tools.isc_interest.description',
	...
	},
	{
		id: 'cusd-celo',
		name: 'cUSD (Celo)',
		descriptionKey: 'chain-tools.tools.cusd_celo.description',
		url: 'https://celo.org',
		icon: CircleDollarSign,
		category: 'stablecoin',
	...
	},
	{
		id: 'ceur-celo',
		name: 'cEUR (Celo)',
		descriptionKey: 'chain-tools.tools.ceur_celo.description',
		url: 'https://celo.org',
		icon: Globe,
		category: 'stablecoin',
	...
	},
	{
		id: 'flexusd',
		name: 'flexUSD',
		descriptionKey: 'chain-tools.tools.flexusd.description',
	...
	},
	{
		id: 'alusd-alchemix',
		name: 'alUSD (Alchemix)',
		descriptionKey: 'chain-tools.tools.alusd_alchemix.description',
	...
	},
	{
		id: 'usd-plus',
		name: 'USD+ (Overnight)',
		descriptionKey: 'chain-tools.tools.usd_plus.description',
	...
	},
	{
		id: 'ust-wormhole',
		name: 'UST (Wormhole)',
		descriptionKey: 'chain-tools.tools.ust_wormhole.description',
