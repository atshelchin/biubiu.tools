...
export const analyticsTools: ExternalTool[] = [
	// ========== Core Analytics Platforms ==========
	{
		id: 'dune',
		name: 'Dune Analytics',
		descriptionKey: 'chain-tools.analytics.tools.dune.description',
		url: 'https://dune.com',
		icon: BarChart3,
		category: 'analytics',
	...
	},
	{
		id: 'defillama',
		name: 'DefiLlama',
		descriptionKey: 'chain-tools.analytics.tools.defillama.description',
	...
	},
	{
		id: 'nansen',
		name: 'Nansen',
		descriptionKey: 'chain-tools.analytics.tools.nansen.description',
	...
	},
	{
		...
		descriptionKey: 'chain-tools.analytics.tools.arkham.description',
	...
	// ========== Token & Market Analytics ==========
	{
		id: 'token-terminal',
		name: 'Token Terminal',
		descriptionKey: 'chain-tools.analytics.tools.token_terminal.description',
	...
	},
	{
		...
		descriptionKey: 'chain-tools.analytics.tools.ultrasound.description',
	...
	},
	{
		id: 'coingecko',
		name: 'CoinGecko',
		descriptionKey: 'chain-tools.analytics.tools.coingecko.description',
	...
	},
	{
		id: 'coinmarketcap',
		name: 'CoinMarketCap',
		descriptionKey: 'chain-tools.analytics.tools.coinmarketcap.description',
	...
	// ========== On-Chain Analytics ==========
	{
		id: 'glassnode',
		name: 'Glassnode',
		descriptionKey: 'chain-tools.analytics.tools.glassnode.description',
	...
	},
	{
		id: 'santiment',
		name: 'Santiment',
		descriptionKey: 'chain-tools.analytics.tools.santiment.description',
	...
	// ========== DEX Analytics ==========
	{
		id: 'dexscreener',
		name: 'DEX Screener',
		descriptionKey: 'chain-tools.analytics.tools.dexscreener.description',
	...
	},
	{
		id: 'defined',
		name: 'Defined.fi',
		descriptionKey: 'chain-tools.analytics.tools.defined.description',
	...
	},
	{
		id: 'bubblemaps',
		name: 'Bubblemaps',
		descriptionKey: 'chain-tools.analytics.tools.bubblemaps.description',
	...
	// ========== L2 Analytics ==========
	{
		id: 'l2beat',
		name: 'L2BEAT',
		descriptionKey: 'chain-tools.analytics.tools.l2beat.description',
	...
	},
	{
		id: 'growthepie',
		name: 'growthepie',
		descriptionKey: 'chain-tools.analytics.tools.growthepie.description',
	...
	// ========== Research Platforms ==========
	{
		id: 'messari',
		name: 'Messari',
		descriptionKey: 'chain-tools.analytics.tools.messari.description',
	...
	// ========== Data Platforms ==========
	{
		id: 'tokenterminal',
		name: 'Token Terminal',
		descriptionKey: 'chain-tools.analytics.tools.tokenterminal.description',
		url: 'https://tokenterminal.com',
		icon: BarChart3,
		category: 'analytics',
	...
	},
	{
		id: 'artemis',
		name: 'Artemis',
		descriptionKey: 'chain-tools.analytics.tools.artemis.description',
	...
	},
	{
		id: 'dappradar',
		name: 'DappRadar',
		descriptionKey: 'chain-tools.analytics.tools.dappradar.description',
	...
	},
	{
		id: 'ethburned',
		name: 'Watch The Burn',
		descriptionKey: 'chain-tools.analytics.tools.ethburned.description',
	...
	},
	{
		id: 'parsec',
		name: 'Parsec Finance',
		descriptionKey: 'chain-tools.analytics.tools.parsec.description',
		url: 'https://parsec.fi',
		icon: BarChart3,
		category: 'analytics',
	...
	},
	{
		id: 'eigenexplorer',
		name: 'EigenExplorer',
		descriptionKey: 'chain-tools.analytics.tools.eigenexplorer.description',
	...
	// ========== SQL & Dashboard Platforms ==========
	{
		...
		descriptionKey: 'chain-tools.analytics.tools.flipside.description',
	...
	},
	{
		...
		descriptionKey: 'chain-tools.analytics.tools.footprint.description',
	...
	},
	{
		id: 'defi-pulse',
		name: 'DeFi Pulse',
		descriptionKey: 'chain-tools.analytics.tools.defi_pulse.description',
	...
	// ========== Fee Analytics ==========
	{
		id: 'l2fees',
		name: 'L2Fees',
		descriptionKey: 'chain-tools.analytics.tools.l2fees.description',
	...
	},
	{
		id: 'cryptofees',
		name: 'CryptoFees',
		descriptionKey: 'chain-tools.analytics.tools.cryptofees.description',
	...
	// ========== Wallet & Whale Tracking ==========
	{
		id: 'watchers',
		name: 'Watchers',
		descriptionKey: 'chain-tools.analytics.tools.watchers.description',
	...
	},
	{
		id: 'cielo',
		name: 'Cielo',
		descriptionKey: 'chain-tools.analytics.tools.cielo.description',
	...
	// ========== APIs & SDKs ==========
	{
		...
		descriptionKey: 'chain-tools.analytics.tools.zerion_api.description',
	...
	},
	{
		id: 'sim-farm',
		name: 'DeFi Simulator',
		descriptionKey: 'chain-tools.analytics.tools.sim_farm.description',
	...
	},
	{
		id: 'openbb',
		name: 'OpenBB',
		descriptionKey: 'chain-tools.analytics.tools.openbb.description',
		url: 'https://openbb.co',
		icon: BarChart3,
		category: 'analytics',
	...
	// ========== Yield Analytics ==========
	{
		...
		descriptionKey: 'chain-tools.analytics.tools.defillama_yields.description',
	...
	},
	{
		id: 'defilabs',
		name: 'DeFi Labs',
		descriptionKey: 'chain-tools.analytics.tools.defilabs.description',
	...
	},
	{
		...
		descriptionKey: 'chain-tools.analytics.tools.chainanalytics.description',
	...
	// ========== Indexing & Data Infrastructure ==========
	{
		id: 'the_graph',
		name: 'The Graph',
		descriptionKey: 'chain-tools.analytics.tools.the_graph.description',
	...
	},
	{
		id: 'space_and_time',
		name: 'Space and Time',
		descriptionKey: 'chain-tools.analytics.tools.space_and_time.description',
	...
	},
	{
		id: 'allium',
		name: 'Allium',
		descriptionKey: 'chain-tools.analytics.tools.allium.description',
		url: 'https://allium.so',
		icon: BarChart3,
		category: 'analytics',
	...
	},
	{
		id: 'sentio',
		name: 'Sentio',
		descriptionKey: 'chain-tools.analytics.tools.sentio.description',
	...
	// ========== New Analytics Tools ==========
	{
		id: 'cookie3',
		name: 'Cookie3',
		descriptionKey: 'chain-tools.analytics.tools.cookie3.description',
	...
	},
	{
		id: 'chainbeat',
		name: 'ChainBeat',
		descriptionKey: 'chain-tools.analytics.tools.chainbeat.description',
	...
	},
	{
		id: 'bitquery',
		name: 'Bitquery',
		descriptionKey: 'chain-tools.analytics.tools.bitquery.description',
	...
	},
	{
		id: 'whale-alert',
		name: 'Whale Alert',
		descriptionKey: 'chain-tools.analytics.tools.whale_alert.description',
	...
	},
	{
		id: 'intotheblock',
		name: 'IntoTheBlock',
		descriptionKey: 'chain-tools.analytics.tools.intotheblock.description',
	...
	},
	{
		id: 'laevitas',
		name: 'Laevitas',
		descriptionKey: 'chain-tools.analytics.tools.laevitas.description',
	...
	},
	{
		id: 'kaiko',
		name: 'Kaiko',
		descriptionKey: 'chain-tools.analytics.tools.kaiko.description',
		url: 'https://kaiko.com',
		icon: BarChart3,
		category: 'analytics',
	...
	},
	{
		id: 'amberdata',
		name: 'Amberdata',
		descriptionKey: 'chain-tools.analytics.tools.amberdata.description',
	...
	},
	{
		id: 'blockpour',
		name: 'Blockpour',
		descriptionKey: 'chain-tools.analytics.tools.blockpour.description',
