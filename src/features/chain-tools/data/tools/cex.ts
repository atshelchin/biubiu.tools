...
export const cexTools: ExternalTool[] = [
	// ========== Tier 1 Global CEX ==========
	{
		id: 'binance-cex',
		name: 'Binance',
		descriptionKey: 'chain-tools.cex.tools.binance_cex.description',
	...
	},
	{
		id: 'coinbase-cex',
		name: 'Coinbase',
		descriptionKey: 'chain-tools.cex.tools.coinbase_cex.description',
	...
	},
	{
		id: 'okx-cex',
		name: 'OKX',
		descriptionKey: 'chain-tools.cex.tools.okx_cex.description',
	...
	},
	{
		id: 'bybit-cex',
		name: 'Bybit',
		descriptionKey: 'chain-tools.cex.tools.bybit_cex.description',
	...
	},
	{
		id: 'kraken-cex',
		name: 'Kraken',
		descriptionKey: 'chain-tools.cex.tools.kraken_cex.description',
	...
	},
	{
		id: 'bitget-cex',
		name: 'Bitget',
		descriptionKey: 'chain-tools.cex.tools.bitget_cex.description',
	...
	},
	{
		id: 'kucoin-cex',
		name: 'KuCoin',
		descriptionKey: 'chain-tools.cex.tools.kucoin_cex.description',
	...
	},
	{
		id: 'gateio-cex',
		name: 'Gate.io',
		descriptionKey: 'chain-tools.cex.tools.gateio_cex.description',
	...
	},
	{
		id: 'htx-cex',
		name: 'HTX (Huobi)',
		descriptionKey: 'chain-tools.cex.tools.htx_cex.description',
	...
	},
	{
		id: 'mexc-cex',
		name: 'MEXC',
		descriptionKey: 'chain-tools.cex.tools.mexc_cex.description',
	...
	// ========== Derivatives Focused ==========
	{
		id: 'deribit-cex',
		name: 'Deribit',
		descriptionKey: 'chain-tools.cex.tools.deribit_cex.description',
	...
	},
	{
		id: 'bitfinex-cex',
		name: 'Bitfinex',
		descriptionKey: 'chain-tools.cex.tools.bitfinex_cex.description',
	...
	},
	{
		id: 'bitmex-cex',
		name: 'BitMEX',
		descriptionKey: 'chain-tools.cex.tools.bitmex_cex.description',
	...
	// ========== Regional Leaders ==========
	{
		id: 'upbit-cex',
		name: 'Upbit',
		descriptionKey: 'chain-tools.cex.tools.upbit_cex.description',
		url: 'https://upbit.com',
		icon: Globe,
		category: 'cex',
	...
	},
	{
		id: 'bithumb-cex',
		name: 'Bithumb',
		descriptionKey: 'chain-tools.cex.tools.bithumb_cex.description',
	...
	},
	{
		id: 'bitflyer-cex',
		name: 'bitFlyer',
		descriptionKey: 'chain-tools.cex.tools.bitflyer_cex.description',
	...
	},
	{
		id: 'coincheck-cex',
		name: 'Coincheck',
		descriptionKey: 'chain-tools.cex.tools.coincheck_cex.description',
	...
	},
	{
		id: 'wazirx-cex',
		name: 'WazirX',
		descriptionKey: 'chain-tools.cex.tools.wazirx_cex.description',
	...
	},
	{
		id: 'bitstamp-cex',
		name: 'Bitstamp',
		descriptionKey: 'chain-tools.cex.tools.bitstamp_cex.description',
	...
	},
	{
		id: 'lbank-cex',
		name: 'LBank',
		descriptionKey: 'chain-tools.cex.tools.lbank_cex.description',
	...
	// ========== Rising Challengers ==========
	{
		...
		descriptionKey: 'chain-tools.cex.tools.backpack_cex.description',
	...
	},
	{
		id: 'hyperliquid-cex',
		name: 'Hyperliquid',
		descriptionKey: 'chain-tools.cex.tools.hyperliquid_cex.description',
	...
	},
	{
		id: 'cube-cex',
		name: 'Cube Exchange',
		descriptionKey: 'chain-tools.cex.tools.cube_cex.description',
	...
	},
	{
		id: 'bullish-cex',
		name: 'Bullish',
		descriptionKey: 'chain-tools.cex.tools.bullish_cex.description',
	...
	},
	{
		...
		descriptionKey: 'chain-tools.cex.tools.hashkey_cex.description',
	...
	},
	{
		id: 'osl-cex',
		name: 'OSL',
		descriptionKey: 'chain-tools.cex.tools.osl_cex.description',
		url: 'https://osl.com',
		icon: Shield,
		category: 'cex',
	...
	// ========== Exchange Comparison & Analytics ==========
	{
		...
		descriptionKey: 'chain-tools.cex.tools.coingecko_exchanges.description',
	...
	},
	{
		...
		descriptionKey: 'chain-tools.cex.tools.cmc_exchanges.description',
	...
	},
	{
		...
		descriptionKey: 'chain-tools.cex.tools.cryptorank_exchanges.description',
	...
	},
	{
		id: 'kaiko-data',
		name: 'Kaiko',
		descriptionKey: 'chain-tools.cex.tools.kaiko_data.description',
	...
	},
	{
		...
		descriptionKey: 'chain-tools.cex.tools.ccdata.description',
		url: 'https://ccdata.io',
		icon: BarChart3,
		category: 'cex',
	...
	// ========== Institutional Trading ==========
	{
		id: 'coinbase-prime',
		name: 'Coinbase Prime',
		descriptionKey: 'chain-tools.cex.tools.coinbase_prime.description',
	...
	},
	{
		...
		descriptionKey: 'chain-tools.cex.tools.binance_institutional.description',
	...
	},
	{
		id: 'galaxy-trading',
		name: 'Galaxy Trading',
		descriptionKey: 'chain-tools.cex.tools.galaxy_trading.description',
	...
	},
	{
		...
		name: 'Cumberland',
		descriptionKey: 'chain-tools.cex.tools.cumberland_trading.description',
	...
	// ========== Crypto-Fiat On/Off Ramps ==========
	{
		id: 'moonpay-ramp',
		name: 'MoonPay',
		descriptionKey: 'chain-tools.cex.tools.moonpay_ramp.description',
	...
	},
	{
		id: 'transak-ramp',
		name: 'Transak',
		descriptionKey: 'chain-tools.cex.tools.transak_ramp.description',
	...
	},
	{
		id: 'ramp-network',
		name: 'Ramp Network',
		descriptionKey: 'chain-tools.cex.tools.ramp_network.description',
	...
	},
	{
		id: 'banxa-ramp',
		name: 'Banxa',
		descriptionKey: 'chain-tools.cex.tools.banxa_ramp.description',
		url: 'https://banxa.com',
		icon: Coins,
		category: 'cex',
	...
	// ========== P2P Trading ==========
	{
		id: 'paxful-p2p',
		name: 'Paxful',
		descriptionKey: 'chain-tools.cex.tools.paxful_p2p.description',
	...
	},
	{
		...
		name: 'LocalBitcoins',
		descriptionKey: 'chain-tools.cex.tools.localbitcoins_p2p.description',
	...
	},
	{
		id: 'noones-p2p',
		name: 'Noones',
		descriptionKey: 'chain-tools.cex.tools.noones_p2p.description',
