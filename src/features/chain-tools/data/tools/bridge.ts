...
export const bridgeTools: ExternalTool[] = [
	// ========== Major Bridges ==========
	{
		...
		descriptionKey: 'bridge.tools.across.description',
		url: 'https://across.to',
		icon: ArrowLeftRight,
		category: 'bridge',
	...
	},
	{
		id: 'stargate',
		name: 'Stargate',
		descriptionKey: 'bridge.tools.stargate.description',
	...
	},
	{
		...
		descriptionKey: 'bridge.tools.orbiter.description',
	...
	// ========== L2 Bridges ==========
	{
		id: 'hop',
		name: 'Hop Protocol',
		descriptionKey: 'bridge.tools.hop.description',
	...
	},
	{
		id: 'synapse',
		name: 'Synapse',
		descriptionKey: 'bridge.tools.synapse.description',
	...
	},
	{
		id: 'cbridge',
		name: 'cBridge',
		descriptionKey: 'bridge.tools.cbridge.description',
	...
	},
	{
		id: 'multichain',
		name: 'Multichain',
		descriptionKey: 'bridge.tools.multichain.description',
	...
	// ========== Messaging Bridges ==========
	{
		id: 'wormhole',
		name: 'Wormhole',
		descriptionKey: 'bridge.tools.wormhole.description',
	...
	},
	{
		id: 'socket',
		name: 'Socket (Bungee)',
		descriptionKey: 'bridge.tools.socket.description',
	...
	},
	{
		id: 'rhino',
		name: 'rhino.fi',
		descriptionKey: 'bridge.tools.rhino.description',
		url: 'https://rhino.fi',
		icon: Shield,
		category: 'bridge',
	...
	// ========== Bridge Aggregators ==========
	{
		id: 'li-fi',
		name: 'LI.FI',
		descriptionKey: 'bridge.tools.li_fi.description',
		url: 'https://li.fi',
		icon: ArrowLeftRight,
		category: 'bridge',
	...
	},
	{
		id: 'bungee',
		name: 'Bungee',
		descriptionKey: 'bridge.tools.bungee.description',
		url: 'https://bungee.exchange',
		icon: ArrowLeftRight,
		category: 'bridge',
	...
	},
	{
		id: 'jumper',
		name: 'Jumper',
		descriptionKey: 'bridge.tools.jumper.description',
	...
	// ========== Specialized Bridges ==========
	{
		...
		descriptionKey: 'bridge.tools.hyphen.description',
	...
	},
	{
		id: 'connext',
		name: 'Connext',
		descriptionKey: 'bridge.tools.connext.description',
	...
	},
	{
		id: 'debridge',
		name: 'deBridge',
		descriptionKey: 'bridge.tools.debridge.description',
	...
	},
	{
		id: 'allbridge',
		name: 'Allbridge',
		descriptionKey: 'bridge.tools.allbridge.description',
	...
	},
	{
		id: 'portal',
		name: 'Portal Bridge',
		descriptionKey: 'bridge.tools.portal.description',
	...
	},
	{
		id: 'squid',
		name: 'Squid Router',
		descriptionKey: 'bridge.tools.squid.description',
	...
	},
	{
		id: 'owlto',
		name: 'Owlto Finance',
		descriptionKey: 'bridge.tools.owlto.description',
	...
	},
	{
		id: 'superbridge',
		name: 'Superbridge',
		descriptionKey: 'bridge.tools.superbridge.description',
	...
	},
	{
		id: 'relay',
		name: 'Relay',
		descriptionKey: 'bridge.tools.relay.description',
	...
	},
	{
		id: 'symbiosis',
		name: 'Symbiosis',
		descriptionKey: 'bridge.tools.symbiosis.description',
	...
	},
	{
		id: 'dln',
		name: 'DLN',
		descriptionKey: 'bridge.tools.dln.description',
		url: 'https://dln.trade',
		icon: ArrowLeftRight,
		category: 'bridge',
	...
	},
	{
		id: 'circle-cctp',
		name: 'Circle CCTP',
		descriptionKey: 'bridge.tools.circle_cctp.description',
	...
	// ========== New Bridge Tools ==========
	{
		id: 'debridge-dln',
		name: 'deBridge DLN',
		descriptionKey: 'bridge.tools.debridge_dln.description',
		url: 'https://dln.trade',
		icon: ArrowLeftRight,
		category: 'bridge',
	...
	},
	{
		id: 'meson-finance',
		name: 'Meson',
		descriptionKey: 'bridge.tools.meson_finance.description',
		url: 'https://meson.fi',
		icon: ArrowLeftRight,
		category: 'bridge',
	...
	},
	{
		id: 'layerswap',
		name: 'Layerswap',
		descriptionKey: 'bridge.tools.layerswap.description',
	...
	},
	{
		...
		descriptionKey: 'bridge.tools.router_protocol.description',
	...
	},
	{
		id: 'nitro-bridge',
		name: 'Nitro Bridge',
		descriptionKey: 'bridge.tools.nitro_bridge.description',
	...
	},
	{
		...
		name: 'Portal Bridge',
		descriptionKey: 'bridge.tools.portal_bridge_wormhole.description',
		url: 'https://portalbridge.com',
		icon: ArrowLeftRight,
		category: 'bridge',
	...
	},
	{
		id: 'celer-im',
		name: 'Celer IM',
		descriptionKey: 'bridge.tools.celer_im.description',
	...
	},
	{
		...
		descriptionKey: 'bridge.tools.multichain_anycall.description',
	...
	},
	{
		id: 'hyperlane-bridge',
		name: 'Hyperlane',
		descriptionKey: 'bridge.tools.hyperlane_bridge.description',
	...
	},
	{
		id: 'connext-amarok',
		name: 'Connext Amarok',
		descriptionKey: 'bridge.tools.connext_amarok.description',
		url: 'https://bridge.connext.network',
		icon: ArrowLeftRight,
		category: 'bridge',
