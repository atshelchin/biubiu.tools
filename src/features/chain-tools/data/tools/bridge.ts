...
export const bridgeTools: ExternalTool[] = [
	// ========== Major Bridges ==========
	{
		...
		descriptionKey: 'chain-tools.bridge.tools.across.description',
		url: 'https://across.to',
		icon: ArrowLeftRight,
		category: 'bridge',
	...
	},
	{
		id: 'stargate',
		name: 'Stargate',
		descriptionKey: 'chain-tools.bridge.tools.stargate.description',
	...
	},
	{
		...
		descriptionKey: 'chain-tools.bridge.tools.orbiter.description',
	...
	// ========== L2 Bridges ==========
	{
		id: 'hop',
		name: 'Hop Protocol',
		descriptionKey: 'chain-tools.bridge.tools.hop.description',
	...
	},
	{
		id: 'synapse',
		name: 'Synapse',
		descriptionKey: 'chain-tools.bridge.tools.synapse.description',
	...
	},
	{
		id: 'cbridge',
		name: 'cBridge',
		descriptionKey: 'chain-tools.bridge.tools.cbridge.description',
	...
	},
	{
		id: 'multichain',
		name: 'Multichain',
		descriptionKey: 'chain-tools.bridge.tools.multichain.description',
	...
	// ========== Messaging Bridges ==========
	{
		id: 'wormhole',
		name: 'Wormhole',
		descriptionKey: 'chain-tools.bridge.tools.wormhole.description',
	...
	},
	{
		id: 'socket',
		name: 'Socket (Bungee)',
		descriptionKey: 'chain-tools.bridge.tools.socket.description',
	...
	},
	{
		id: 'rhino',
		name: 'rhino.fi',
		descriptionKey: 'chain-tools.bridge.tools.rhino.description',
		url: 'https://rhino.fi',
		icon: Shield,
		category: 'bridge',
	...
	// ========== Bridge Aggregators ==========
	{
		id: 'li-fi',
		name: 'LI.FI',
		descriptionKey: 'chain-tools.bridge.tools.li_fi.description',
		url: 'https://li.fi',
		icon: ArrowLeftRight,
		category: 'bridge',
	...
	},
	{
		id: 'bungee',
		name: 'Bungee',
		descriptionKey: 'chain-tools.bridge.tools.bungee.description',
		url: 'https://bungee.exchange',
		icon: ArrowLeftRight,
		category: 'bridge',
	...
	},
	{
		id: 'jumper',
		name: 'Jumper',
		descriptionKey: 'chain-tools.bridge.tools.jumper.description',
	...
	// ========== Specialized Bridges ==========
	{
		...
		descriptionKey: 'chain-tools.bridge.tools.hyphen.description',
	...
	},
	{
		id: 'connext',
		name: 'Connext',
		descriptionKey: 'chain-tools.bridge.tools.connext.description',
	...
	},
	{
		id: 'debridge',
		name: 'deBridge',
		descriptionKey: 'chain-tools.bridge.tools.debridge.description',
	...
	},
	{
		id: 'allbridge',
		name: 'Allbridge',
		descriptionKey: 'chain-tools.bridge.tools.allbridge.description',
	...
	},
	{
		id: 'portal',
		name: 'Portal Bridge',
		descriptionKey: 'chain-tools.bridge.tools.portal.description',
	...
	},
	{
		id: 'squid',
		name: 'Squid Router',
		descriptionKey: 'chain-tools.bridge.tools.squid.description',
	...
	},
	{
		id: 'owlto',
		name: 'Owlto Finance',
		descriptionKey: 'chain-tools.bridge.tools.owlto.description',
	...
	},
	{
		id: 'superbridge',
		name: 'Superbridge',
		descriptionKey: 'chain-tools.bridge.tools.superbridge.description',
	...
	},
	{
		id: 'relay',
		name: 'Relay',
		descriptionKey: 'chain-tools.bridge.tools.relay.description',
	...
	},
	{
		id: 'symbiosis',
		name: 'Symbiosis',
		descriptionKey: 'chain-tools.bridge.tools.symbiosis.description',
	...
	},
	{
		id: 'dln',
		name: 'DLN',
		descriptionKey: 'chain-tools.bridge.tools.dln.description',
		url: 'https://dln.trade',
		icon: ArrowLeftRight,
		category: 'bridge',
	...
	},
	{
		id: 'circle-cctp',
		name: 'Circle CCTP',
		descriptionKey: 'chain-tools.bridge.tools.circle_cctp.description',
	...
	// ========== New Bridge Tools ==========
	{
		id: 'debridge-dln',
		name: 'deBridge DLN',
		descriptionKey: 'chain-tools.bridge.tools.debridge_dln.description',
		url: 'https://dln.trade',
		icon: ArrowLeftRight,
		category: 'bridge',
	...
	},
	{
		id: 'meson-finance',
		name: 'Meson',
		descriptionKey: 'chain-tools.bridge.tools.meson_finance.description',
		url: 'https://meson.fi',
		icon: ArrowLeftRight,
		category: 'bridge',
	...
	},
	{
		id: 'layerswap',
		name: 'Layerswap',
		descriptionKey: 'chain-tools.bridge.tools.layerswap.description',
	...
	},
	{
		...
		descriptionKey: 'chain-tools.bridge.tools.router_protocol.description',
	...
	},
	{
		id: 'nitro-bridge',
		name: 'Nitro Bridge',
		descriptionKey: 'chain-tools.bridge.tools.nitro_bridge.description',
	...
	},
	{
		...
		name: 'Portal Bridge',
		descriptionKey: 'chain-tools.bridge.tools.portal_bridge_wormhole.description',
		url: 'https://portalbridge.com',
		icon: ArrowLeftRight,
		category: 'bridge',
	...
	},
	{
		id: 'celer-im',
		name: 'Celer IM',
		descriptionKey: 'chain-tools.bridge.tools.celer_im.description',
	...
	},
	{
		...
		descriptionKey: 'chain-tools.bridge.tools.multichain_anycall.description',
	...
	},
	{
		id: 'hyperlane-bridge',
		name: 'Hyperlane',
		descriptionKey: 'chain-tools.bridge.tools.hyperlane_bridge.description',
	...
	},
	{
		id: 'connext-amarok',
		name: 'Connext Amarok',
		descriptionKey: 'chain-tools.bridge.tools.connext_amarok.description',
		url: 'https://bridge.connext.network',
		icon: ArrowLeftRight,
		category: 'bridge',
