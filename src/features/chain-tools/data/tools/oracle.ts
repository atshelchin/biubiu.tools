...
export const oracleTools: ExternalTool[] = [
	// ========== Major Decentralized Oracles ==========
	{
		id: 'chainlink',
		name: 'Chainlink',
		descriptionKey: 'chain-tools.oracle.tools.chainlink.description',
	...
	},
	{
		...
		descriptionKey: 'chain-tools.oracle.tools.chainlink_data_feeds.description',
	...
	},
	{
		id: 'pyth-network',
		name: 'Pyth Network',
		descriptionKey: 'chain-tools.oracle.tools.pyth_network.description',
	...
	},
	{
		...
		descriptionKey: 'chain-tools.oracle.tools.pyth_price_feeds.description',
	...
	},
	{
		id: 'band-protocol',
		name: 'Band Protocol',
		descriptionKey: 'chain-tools.oracle.tools.band_protocol.description',
	...
	},
	{
		id: 'api3',
		name: 'API3',
		descriptionKey: 'chain-tools.oracle.tools.api3.description',
		url: 'https://api3.org',
		icon: Cpu,
		category: 'oracle',
	...
	},
	{
		id: 'dia-data',
		name: 'DIA Data',
		descriptionKey: 'chain-tools.oracle.tools.dia_data.description',
	...
	},
	{
		id: 'tellor',
		name: 'Tellor',
		descriptionKey: 'chain-tools.oracle.tools.tellor.description',
		url: 'https://tellor.io',
		icon: Shield,
		category: 'oracle',
	...
	},
	{
		id: 'uma-protocol',
		name: 'UMA Protocol',
		descriptionKey: 'chain-tools.oracle.tools.uma_protocol.description',
		url: 'https://uma.xyz',
		icon: Globe,
		category: 'oracle',
	...
	},
	{
		...
		descriptionKey: 'chain-tools.oracle.tools.redstone_oracles.description',
	...
	},
	{
		id: 'chronicle-labs',
		name: 'Chronicle Labs',
		descriptionKey: 'chain-tools.oracle.tools.chronicle_labs.description',
	...
	},
	{
		...
		descriptionKey: 'chain-tools.oracle.tools.umbrella_network.description',
	...
	},
	{
		id: 'flux-protocol',
		name: 'Flux Protocol',
		descriptionKey: 'chain-tools.oracle.tools.flux_protocol.description',
	...
	},
	{
		id: 'supra-oracles',
		name: 'Supra Oracles',
		descriptionKey: 'chain-tools.oracle.tools.supra_oracles.description',
		url: 'https://supra.com',
		icon: Zap,
		category: 'oracle',
	...
	// ========== Specialized Oracles ==========
	{
		id: 'chainlink-vrf',
		name: 'Chainlink VRF',
		descriptionKey: 'chain-tools.oracle.tools.chainlink_vrf.description',
	...
	},
	{
		...
		descriptionKey: 'chain-tools.oracle.tools.chainlink_automation.description',
	...
	},
	{
		id: 'chainlink-ccip',
		name: 'Chainlink CCIP',
		descriptionKey: 'chain-tools.oracle.tools.chainlink_ccip.description',
	...
	},
	{
		...
		descriptionKey: 'chain-tools.oracle.tools.chainlink_functions.description',
	...
	// ========== Oracle Aggregators & Tools ==========
	{
		...
		descriptionKey: 'chain-tools.oracle.tools.defillama_oracles.description',
	...
	},
	{
		id: 'oracle-dao',
		name: 'Oracle DAO',
		descriptionKey: 'chain-tools.oracle.tools.oracle_dao.description',
		url: 'https://oracle.io',
		icon: Shield,
		category: 'oracle',
