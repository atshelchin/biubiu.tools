...
export const oracleTools: ExternalTool[] = [
	...
	},
	{
		...
		descriptionKey: 'chain-tools.tools.chainlink_data_feeds.description',
	...
	},
	{
		id: 'pyth-network',
		name: 'Pyth Network',
		descriptionKey: 'chain-tools.tools.pyth_network.description',
	...
	},
	{
		...
		descriptionKey: 'chain-tools.tools.pyth_price_feeds.description',
	...
	},
	{
		id: 'api3',
		name: 'API3',
		descriptionKey: 'chain-tools.tools.api3.description',
		url: 'https://api3.org',
		icon: Cpu,
		category: 'oracle',
	...
	},
	{
		id: 'dia-data',
		name: 'DIA Data',
		descriptionKey: 'chain-tools.tools.dia_data.description',
	...
	},
	{
		id: 'uma-protocol',
		name: 'UMA Protocol',
		descriptionKey: 'chain-tools.tools.uma_protocol.description',
		url: 'https://uma.xyz',
		icon: Globe,
		category: 'oracle',
	...
	},
	{
		...
		descriptionKey: 'chain-tools.tools.redstone_oracles.description',
	...
	},
	{
		id: 'chronicle-labs',
		name: 'Chronicle Labs',
		descriptionKey: 'chain-tools.tools.chronicle_labs.description',
	...
	},
	{
		...
		descriptionKey: 'chain-tools.tools.umbrella_network.description',
	...
	},
	{
		id: 'flux-protocol',
		name: 'Flux Protocol',
		descriptionKey: 'chain-tools.tools.flux_protocol.description',
	...
	},
	{
		id: 'supra-oracles',
		name: 'Supra Oracles',
		descriptionKey: 'chain-tools.tools.supra_oracles.description',
		url: 'https://supra.com',
		icon: Zap,
		category: 'oracle',
	...
	// ========== Specialized Oracles ==========
	{
		id: 'chainlink-vrf',
		name: 'Chainlink VRF',
		descriptionKey: 'chain-tools.tools.chainlink_vrf.description',
	...
	},
	{
		...
		descriptionKey: 'chain-tools.tools.chainlink_automation.description',
	...
	},
	{
		id: 'chainlink-ccip',
		name: 'Chainlink CCIP',
		descriptionKey: 'chain-tools.tools.chainlink_ccip.description',
	...
	},
	{
		...
		descriptionKey: 'chain-tools.tools.chainlink_functions.description',
	...
	// ========== Oracle Aggregators & Tools ==========
	{
		...
		descriptionKey: 'chain-tools.tools.defillama_oracles.description',
	...
	},
	{
		id: 'oracle-dao',
		name: 'Oracle DAO',
		descriptionKey: 'chain-tools.tools.oracle_dao.description',
		url: 'https://oracle.io',
		icon: Shield,
		category: 'oracle',
