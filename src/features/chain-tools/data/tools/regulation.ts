...
export const regulationTools: ExternalTool[] = [
	// ========== US Regulatory Bodies ==========
	{
		id: 'sec-crypto',
		name: 'SEC (US)',
		descriptionKey: 'routes/apps/chain-tools/regulation.tools.sec_crypto.description',
	...
	},
	{
		id: 'cftc-crypto',
		name: 'CFTC (US)',
		descriptionKey: 'routes/apps/chain-tools/regulation.tools.cftc_crypto.description',
	...
	},
	{
		id: 'fincen-crypto',
		name: 'FinCEN (US)',
		descriptionKey: 'routes/apps/chain-tools/regulation.tools.fincen_crypto.description',
	...
	},
	{
		id: 'occ-crypto',
		name: 'OCC (US)',
		descriptionKey: 'routes/apps/chain-tools/regulation.tools.occ_crypto.description',
	...
	},
	{
		...
		descriptionKey: 'routes/apps/chain-tools/regulation.tools.fed_crypto.description',
	...
	},
	{
		...
		descriptionKey: 'routes/apps/chain-tools/regulation.tools.nydfs_crypto.description',
	...
	// ========== EU & UK Regulation ==========
	{
		id: 'mica-eu',
		name: 'MiCA (EU)',
		descriptionKey: 'routes/apps/chain-tools/regulation.tools.mica_eu.description',
	...
	},
	{
		id: 'esma-crypto',
		name: 'ESMA (EU)',
		descriptionKey: 'routes/apps/chain-tools/regulation.tools.esma_crypto.description',
	...
	},
	{
		id: 'eba-crypto',
		name: 'EBA (EU)',
		descriptionKey: 'routes/apps/chain-tools/regulation.tools.eba_crypto.description',
	...
	},
	{
		id: 'fca-crypto',
		name: 'FCA (UK)',
		descriptionKey: 'routes/apps/chain-tools/regulation.tools.fca_crypto.description',
	...
	},
	{
		id: 'bafin-crypto',
		name: 'BaFin (Germany)',
		descriptionKey: 'routes/apps/chain-tools/regulation.tools.bafin_crypto.description',
	...
	},
	{
		id: 'amf-crypto',
		name: 'AMF (France)',
		descriptionKey: 'routes/apps/chain-tools/regulation.tools.amf_crypto.description',
	...
	},
	{
		...
		descriptionKey: 'routes/apps/chain-tools/regulation.tools.finma_crypto.description',
	...
	// ========== Asia-Pacific Regulation ==========
	{
		id: 'hkma-crypto',
		name: 'HKMA (Hong Kong)',
		descriptionKey: 'routes/apps/chain-tools/regulation.tools.hkma_crypto.description',
	...
	},
	{
		id: 'sfc-hk',
		name: 'SFC (Hong Kong)',
		descriptionKey: 'routes/apps/chain-tools/regulation.tools.sfc_hk.description',
	...
	},
	{
		id: 'mas-crypto',
		name: 'MAS (Singapore)',
		descriptionKey: 'routes/apps/chain-tools/regulation.tools.mas_crypto.description',
	...
	},
	{
		id: 'jfsa-crypto',
		name: 'JFSA (Japan)',
		descriptionKey: 'routes/apps/chain-tools/regulation.tools.jfsa_crypto.description',
	...
	},
	{
		...
		descriptionKey: 'routes/apps/chain-tools/regulation.tools.fsc_korea.description',
	...
	},
	{
		id: 'asic-crypto',
		name: 'ASIC (Australia)',
		descriptionKey: 'routes/apps/chain-tools/regulation.tools.asic_crypto.description',
	...
	},
	{
		id: 'rbi-crypto',
		name: 'RBI (India)',
		descriptionKey: 'routes/apps/chain-tools/regulation.tools.rbi_crypto.description',
	...
	// ========== Middle East & Africa ==========
	{
		id: 'vara-dubai',
		name: 'VARA (Dubai)',
		descriptionKey: 'routes/apps/chain-tools/regulation.tools.vara_dubai.description',
		url: 'https://vara.ae',
		icon: Landmark,
		category: 'regulation',
	...
	},
	{
		id: 'adgm-crypto',
		name: 'ADGM (Abu Dhabi)',
		descriptionKey: 'routes/apps/chain-tools/regulation.tools.adgm_crypto.description',
	...
	},
	{
		...
		descriptionKey: 'routes/apps/chain-tools/regulation.tools.sama_crypto.description',
	...
	},
	{
		...
		descriptionKey: 'routes/apps/chain-tools/regulation.tools.sarb_crypto.description',
	...
	// ========== Americas (Non-US) ==========
	{
		id: 'csa-crypto',
		name: 'CSA (Canada)',
		descriptionKey: 'routes/apps/chain-tools/regulation.tools.csa_crypto.description',
	...
	},
	{
		id: 'cnbv-crypto',
		name: 'CNBV (Mexico)',
		descriptionKey: 'routes/apps/chain-tools/regulation.tools.cnbv_crypto.description',
	...
	},
	{
		id: 'bcra-crypto',
		name: 'BCRA (Argentina)',
		descriptionKey: 'routes/apps/chain-tools/regulation.tools.bcra_crypto.description',
	...
	},
	{
		id: 'cvm-brazil',
		name: 'CVM (Brazil)',
		descriptionKey: 'routes/apps/chain-tools/regulation.tools.cvm_brazil.description',
	...
	// ========== Global Organizations ==========
	{
		id: 'fatf-crypto',
		name: 'FATF',
		descriptionKey: 'routes/apps/chain-tools/regulation.tools.fatf_crypto.description',
	...
	},
	{
		id: 'bis-crypto',
		name: 'BIS',
		descriptionKey: 'routes/apps/chain-tools/regulation.tools.bis_crypto.description',
	...
	},
	{
		id: 'fsb-crypto',
		name: 'FSB',
		descriptionKey: 'routes/apps/chain-tools/regulation.tools.fsb_crypto.description',
	...
	},
	{
		id: 'iosco-crypto',
		name: 'IOSCO',
		descriptionKey: 'routes/apps/chain-tools/regulation.tools.iosco_crypto.description',
	...
	// ========== Legal Resources & Research ==========
	{
		...
		descriptionKey: 'routes/apps/chain-tools/regulation.tools.coinbase_legal.description',
	...
	},
	{
		...
		descriptionKey: 'routes/apps/chain-tools/regulation.tools.a16z_policy.description',
	...
	},
	{
		...
		descriptionKey: 'routes/apps/chain-tools/regulation.tools.blockchain_association.description',
	...
	},
	{
		id: 'coin-center',
		name: 'Coin Center',
		descriptionKey: 'routes/apps/chain-tools/regulation.tools.coin_center.description',
	...
	},
	{
		...
		name: 'CBDC Tracker',
		descriptionKey: 'routes/apps/chain-tools/regulation.tools.atlanticcouncil_cbdc.description',
	...
	},
	{
		...
		descriptionKey: 'routes/apps/chain-tools/regulation.tools.global_crypto_map.description',
	...
	// ========== Compliance Tools ==========
	{
		...
		name: 'Chainalysis',
		descriptionKey: 'routes/apps/chain-tools/regulation.tools.chainalysis_compliance.description',
	...
	},
	{
		...
		name: 'Elliptic',
		descriptionKey: 'routes/apps/chain-tools/regulation.tools.elliptic_compliance.description',
	...
	},
	{
		id: 'trm-labs',
		name: 'TRM Labs',
		descriptionKey: 'routes/apps/chain-tools/regulation.tools.trm_labs.description',
	...
	},
	{
		id: 'merkle-science',
		name: 'Merkle Science',
		descriptionKey: 'routes/apps/chain-tools/regulation.tools.merkle_science.description',
	...
	},
	{
		id: 'notabene-travel',
		name: 'Notabene',
		descriptionKey: 'routes/apps/chain-tools/regulation.tools.notabene_travel.description',
	...
	},
	{
		id: 'sumsub-kyc',
		name: 'Sumsub',
		descriptionKey: 'routes/apps/chain-tools/regulation.tools.sumsub_kyc.description',
