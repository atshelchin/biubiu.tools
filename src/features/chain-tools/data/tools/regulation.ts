...
export const regulationTools: ExternalTool[] = [
	// ========== US Regulatory Bodies ==========
	{
		id: 'sec-crypto',
		name: 'SEC (US)',
		descriptionKey: 'chain-tools.tools.sec_crypto.description',
	...
	},
	{
		id: 'cftc-crypto',
		name: 'CFTC (US)',
		descriptionKey: 'chain-tools.tools.cftc_crypto.description',
	...
	},
	{
		id: 'fincen-crypto',
		name: 'FinCEN (US)',
		descriptionKey: 'chain-tools.tools.fincen_crypto.description',
	...
	},
	{
		id: 'occ-crypto',
		name: 'OCC (US)',
		descriptionKey: 'chain-tools.tools.occ_crypto.description',
	...
	},
	{
		...
		descriptionKey: 'chain-tools.tools.fed_crypto.description',
	...
	},
	{
		...
		descriptionKey: 'chain-tools.tools.nydfs_crypto.description',
	...
	// ========== EU & UK Regulation ==========
	{
		id: 'mica-eu',
		name: 'MiCA (EU)',
		descriptionKey: 'chain-tools.tools.mica_eu.description',
	...
	},
	{
		id: 'esma-crypto',
		name: 'ESMA (EU)',
		descriptionKey: 'chain-tools.tools.esma_crypto.description',
	...
	},
	{
		id: 'eba-crypto',
		name: 'EBA (EU)',
		descriptionKey: 'chain-tools.tools.eba_crypto.description',
	...
	},
	{
		id: 'fca-crypto',
		name: 'FCA (UK)',
		descriptionKey: 'chain-tools.tools.fca_crypto.description',
	...
	},
	{
		id: 'bafin-crypto',
		name: 'BaFin (Germany)',
		descriptionKey: 'chain-tools.tools.bafin_crypto.description',
	...
	},
	{
		id: 'amf-crypto',
		name: 'AMF (France)',
		descriptionKey: 'chain-tools.tools.amf_crypto.description',
	...
	},
	{
		...
		descriptionKey: 'chain-tools.tools.finma_crypto.description',
	...
	// ========== Asia-Pacific Regulation ==========
	{
		id: 'hkma-crypto',
		name: 'HKMA (Hong Kong)',
		descriptionKey: 'chain-tools.tools.hkma_crypto.description',
	...
	},
	{
		id: 'sfc-hk',
		name: 'SFC (Hong Kong)',
		descriptionKey: 'chain-tools.tools.sfc_hk.description',
	...
	},
	{
		id: 'mas-crypto',
		name: 'MAS (Singapore)',
		descriptionKey: 'chain-tools.tools.mas_crypto.description',
	...
	},
	{
		id: 'jfsa-crypto',
		name: 'JFSA (Japan)',
		descriptionKey: 'chain-tools.tools.jfsa_crypto.description',
	...
	},
	{
		...
		descriptionKey: 'chain-tools.tools.fsc_korea.description',
	...
	},
	{
		id: 'asic-crypto',
		name: 'ASIC (Australia)',
		descriptionKey: 'chain-tools.tools.asic_crypto.description',
	...
	},
	{
		id: 'rbi-crypto',
		name: 'RBI (India)',
		descriptionKey: 'chain-tools.tools.rbi_crypto.description',
	...
	// ========== Middle East & Africa ==========
	{
		id: 'vara-dubai',
		name: 'VARA (Dubai)',
		descriptionKey: 'chain-tools.tools.vara_dubai.description',
		url: 'https://vara.ae',
		icon: Landmark,
		category: 'regulation',
	...
	},
	{
		id: 'adgm-crypto',
		name: 'ADGM (Abu Dhabi)',
		descriptionKey: 'chain-tools.tools.adgm_crypto.description',
	...
	},
	{
		...
		descriptionKey: 'chain-tools.tools.sama_crypto.description',
	...
	},
	{
		...
		descriptionKey: 'chain-tools.tools.sarb_crypto.description',
	...
	// ========== Americas (Non-US) ==========
	{
		id: 'csa-crypto',
		name: 'CSA (Canada)',
		descriptionKey: 'chain-tools.tools.csa_crypto.description',
	...
	},
	{
		id: 'cnbv-crypto',
		name: 'CNBV (Mexico)',
		descriptionKey: 'chain-tools.tools.cnbv_crypto.description',
	...
	},
	{
		id: 'bcra-crypto',
		name: 'BCRA (Argentina)',
		descriptionKey: 'chain-tools.tools.bcra_crypto.description',
	...
	},
	{
		id: 'cvm-brazil',
		name: 'CVM (Brazil)',
		descriptionKey: 'chain-tools.tools.cvm_brazil.description',
	...
	// ========== Global Organizations ==========
	{
		id: 'fatf-crypto',
		name: 'FATF',
		descriptionKey: 'chain-tools.tools.fatf_crypto.description',
	...
	},
	{
		id: 'bis-crypto',
		name: 'BIS',
		descriptionKey: 'chain-tools.tools.bis_crypto.description',
	...
	},
	{
		id: 'fsb-crypto',
		name: 'FSB',
		descriptionKey: 'chain-tools.tools.fsb_crypto.description',
	...
	},
	{
		id: 'iosco-crypto',
		name: 'IOSCO',
		descriptionKey: 'chain-tools.tools.iosco_crypto.description',
	...
	// ========== Legal Resources & Research ==========
	{
		...
		descriptionKey: 'chain-tools.tools.coinbase_legal.description',
	...
	},
	{
		...
		descriptionKey: 'chain-tools.tools.a16z_policy.description',
	...
	},
	{
		...
		descriptionKey: 'chain-tools.tools.blockchain_association.description',
	...
	},
	{
		id: 'coin-center',
		name: 'Coin Center',
		descriptionKey: 'chain-tools.tools.coin_center.description',
	...
	},
	{
		...
		name: 'CBDC Tracker',
		descriptionKey: 'chain-tools.tools.atlanticcouncil_cbdc.description',
	...
	},
	{
		...
		descriptionKey: 'chain-tools.tools.global_crypto_map.description',
	...
	// ========== Compliance Tools ==========
	{
		...
		name: 'Chainalysis',
		descriptionKey: 'chain-tools.tools.chainalysis_compliance.description',
	...
	},
	{
		...
		name: 'Elliptic',
		descriptionKey: 'chain-tools.tools.elliptic_compliance.description',
	...
	},
	{
		id: 'trm-labs',
		name: 'TRM Labs',
		descriptionKey: 'chain-tools.tools.trm_labs.description',
	...
	},
	{
		id: 'merkle-science',
		name: 'Merkle Science',
		descriptionKey: 'chain-tools.tools.merkle_science.description',
	...
	},
	{
		id: 'notabene-travel',
		name: 'Notabene',
		descriptionKey: 'chain-tools.tools.notabene_travel.description',
	...
	},
	{
		id: 'sumsub-kyc',
		name: 'Sumsub',
		descriptionKey: 'chain-tools.tools.sumsub_kyc.description',
