...
export const launchpadTools: ExternalTool[] = [
	// ========== Major Launchpads ==========
	{
		id: 'pump-fun',
		name: 'Pump.fun',
		descriptionKey: 'routes/apps/chain-tools/launchpad.tools.pump_fun.description',
		url: 'https://pump.fun',
		icon: Rocket,
		category: 'launchpad',
	...
	},
	{
		id: 'four_meme',
		name: 'Four.meme',
		descriptionKey: 'routes/apps/chain-tools/launchpad.tools.four_meme.description',
		url: 'https://four.meme',
		icon: Rocket,
		category: 'launchpad',
	...
	},
	{
		id: 'dao-maker',
		name: 'DAO Maker',
		descriptionKey: 'routes/apps/chain-tools/launchpad.tools.dao_maker.description',
	...
	},
	{
		id: 'fjord-foundry',
		name: 'Fjord Foundry',
		descriptionKey: 'routes/apps/chain-tools/launchpad.tools.fjord_foundry.description',
	...
	},
	{
		...
		descriptionKey: 'routes/apps/chain-tools/launchpad.tools.camelot_launchpad.description',
	...
	// ========== Presale Platforms ==========
	{
		id: 'pinksale',
		name: 'PinkSale',
		descriptionKey: 'routes/apps/chain-tools/launchpad.tools.pinksale.description',
	...
	},
	{
		id: 'gempad',
		name: 'GemPad',
		descriptionKey: 'routes/apps/chain-tools/launchpad.tools.gempad.description',
	...
	// ========== NFT Launch Platforms ==========
	{
		id: 'mint-fun',
		name: 'Mint.fun',
		descriptionKey: 'routes/apps/chain-tools/launchpad.tools.mint_fun.description',
		url: 'https://mint.fun',
		icon: Sparkles,
		category: 'launchpad',
	...
	},
	{
		id: 'zora-create',
		name: 'Zora Create',
		descriptionKey: 'routes/apps/chain-tools/launchpad.tools.zora_create.description',
	...
	},
	{
		...
		descriptionKey: 'routes/apps/chain-tools/launchpad.tools.thirdweb_deploy.description',
	...
	// ========== GameFi Launchpads ==========
	{
		id: 'seedify',
		name: 'Seedify',
		descriptionKey: 'routes/apps/chain-tools/launchpad.tools.seedify.description',
	...
	},
	{
		id: 'polkastarter',
		name: 'Polkastarter',
		descriptionKey: 'routes/apps/chain-tools/launchpad.tools.polkastarter.description',
	...
	},
	{
		...
		descriptionKey: 'routes/apps/chain-tools/launchpad.tools.gamefi_launchpad.description',
	...
	},
	{
		id: 'enjinstarter',
		name: 'Enjinstarter',
		descriptionKey: 'routes/apps/chain-tools/launchpad.tools.enjinstarter.description',
	...
	// ========== Meme Token Launchpads ==========
	{
		id: 'sunpump',
		name: 'SunPump',
		descriptionKey: 'routes/apps/chain-tools/launchpad.tools.sunpump.description',
	...
	},
	{
		id: 'moonshot',
		name: 'Moonshot',
		descriptionKey: 'routes/apps/chain-tools/launchpad.tools.moonshot.description',
	...
	},
	{
		id: 'ape_store',
		name: 'Ape.Store',
		descriptionKey: 'routes/apps/chain-tools/launchpad.tools.ape_store.description',
		url: 'https://ape.store',
		icon: Rocket,
		category: 'launchpad',
	...
	},
	{
		id: 'believe',
		name: 'Believe',
		descriptionKey: 'routes/apps/chain-tools/launchpad.tools.believe.description',
	...
	},
	{
		...
		descriptionKey: 'routes/apps/chain-tools/launchpad.tools.virtuals.description',
	...
	},
	{
		id: 'clanker',
		name: 'Clanker',
		descriptionKey: 'routes/apps/chain-tools/launchpad.tools.clanker.description',
	...
	},
	{
		...
		descriptionKey: 'routes/apps/chain-tools/launchpad.tools.dexscreener_moonshot.description',
	...
	// ========== Multi-chain Launchpads ==========
	{
		id: 'bounce',
		name: 'Bounce',
		descriptionKey: 'routes/apps/chain-tools/launchpad.tools.bounce.description',
	...
	},
	{
		id: 'tokensoft',
		name: 'Tokensoft',
		descriptionKey: 'routes/apps/chain-tools/launchpad.tools.tokensoft.description',
	...
	},
	{
		id: 'starter',
		name: 'Starter',
		descriptionKey: 'routes/apps/chain-tools/launchpad.tools.starter.description',
	...
	},
	{
		...
		descriptionKey: 'routes/apps/chain-tools/launchpad.tools.impossible_finance.description',
	...
	},
	{
		id: 'kommunitas',
		name: 'Kommunitas',
		descriptionKey: 'routes/apps/chain-tools/launchpad.tools.kommunitas.description',
	...
	},
	{
		id: 'red_kite',
		name: 'Red Kite',
		descriptionKey: 'routes/apps/chain-tools/launchpad.tools.red_kite.description',
	...
	},
	{
		id: 'trustpad',
		name: 'TrustPad',
		descriptionKey: 'routes/apps/chain-tools/launchpad.tools.trustpad.description',
	...
	},
	{
		id: 'spores',
		name: 'Spores Network',
		descriptionKey: 'routes/apps/chain-tools/launchpad.tools.spores.description',
	...
	},
	{
		id: 'bullperks',
		name: 'BullPerks',
		descriptionKey: 'routes/apps/chain-tools/launchpad.tools.bullperks.description',
	...
	},
	{
		id: 'decubate',
		name: 'Decubate',
		descriptionKey: 'routes/apps/chain-tools/launchpad.tools.decubate.description',
	...
	},
	{
		id: 'ape-terminal',
		name: 'Ape Terminal',
		descriptionKey: 'routes/apps/chain-tools/launchpad.tools.ape_terminal.description',
	...
	// ========== TON Launchpads ==========
	{
		...
		descriptionKey: 'routes/apps/chain-tools/launchpad.tools.gagarin.description',
	...
	},
	{
		id: 'tonstarter',
		name: 'TONStarter',
		descriptionKey: 'routes/apps/chain-tools/launchpad.tools.tonstarter.description',
	...
	// ========== Solana Launchpads ==========
	{
		id: 'lfg_launchpad',
		name: 'LFG Launchpad',
		descriptionKey: 'routes/apps/chain-tools/launchpad.tools.lfg_launchpad.description',
	...
	},
	{
		...
		name: 'AcceleRaytor',
		descriptionKey: 'routes/apps/chain-tools/launchpad.tools.raydium_acceleraytor.description',
	...
	},
	{
		id: 'meteora_dlmm',
		name: 'Meteora DLMM',
		descriptionKey: 'routes/apps/chain-tools/launchpad.tools.meteora_dlmm.description',
	...
	},
	{
		...
		descriptionKey: 'routes/apps/chain-tools/launchpad.tools.orca_whirlpools.description',
		url: 'https://orca.so',
		icon: Droplets,
		category: 'launchpad',
	...
	},
	{
		id: 'legion',
		name: 'Legion',
		descriptionKey: 'routes/apps/chain-tools/launchpad.tools.legion.description',
		url: 'https://legion.cc',
		icon: Rocket,
		category: 'launchpad',
	...
	},
	{
		id: 'armada',
		name: 'Armada',
		descriptionKey: 'routes/apps/chain-tools/launchpad.tools.armada.description',
		url: 'https://armada.so',
		icon: Rocket,
		category: 'launchpad',
	...
	},
	{
		id: 'poolside-fi',
		name: 'Poolside',
		descriptionKey: 'routes/apps/chain-tools/launchpad.tools.poolside_fi.description',
	...
	// ========== Vesting & Token Management ==========
	{
		id: 'hedgey',
		name: 'Hedgey',
		descriptionKey: 'routes/apps/chain-tools/launchpad.tools.hedgey.description',
	...
	},
	{
		id: 'magna',
		name: 'Magna',
		descriptionKey: 'routes/apps/chain-tools/launchpad.tools.magna.description',
		url: 'https://magna.so',
		icon: Lock,
		category: 'launchpad',
	...
	},
	{
		...
		descriptionKey: 'routes/apps/chain-tools/launchpad.tools.superfluid_vesting.description',
	...
	},
	{
		id: 'streamflow',
		name: 'Streamflow',
		descriptionKey: 'routes/apps/chain-tools/launchpad.tools.streamflow.description',
	...
	},
	{
		id: 'vestinglab',
		name: 'VestingLab',
		descriptionKey: 'routes/apps/chain-tools/launchpad.tools.vestinglab.description',
	...
	// ========== New Launchpads ==========
	{
		id: 'echo-launchpad',
		name: 'Echo',
		descriptionKey: 'routes/apps/chain-tools/launchpad.tools.echo_launchpad.description',
		url: 'https://echo.xyz',
		icon: Rocket,
		category: 'launchpad',
	...
	},
	{
		...
		name: 'BonsaiDAO',
		descriptionKey: 'routes/apps/chain-tools/launchpad.tools.bonsaidao_launchpad.description',
	...
	},
	{
		id: 'axis-finance',
		name: 'Axis Finance',
		descriptionKey: 'routes/apps/chain-tools/launchpad.tools.axis_finance.description',
	...
	},
	{
		id: 'surge-launchpad',
		name: 'Surge',
		descriptionKey: 'routes/apps/chain-tools/launchpad.tools.surge_launchpad.description',
	...
	},
	{
		...
		name: 'Blastoff',
		descriptionKey: 'routes/apps/chain-tools/launchpad.tools.blastoff_launchpad.description',
	...
	},
	{
		...
		descriptionKey: 'routes/apps/chain-tools/launchpad.tools.daomaker_launchpad.description',
	...
	},
	{
		...
		descriptionKey: 'routes/apps/chain-tools/launchpad.tools.seedify_launchpad.description',
	...
	},
	{
		id: 'coinstarter',
		name: 'CoinStarter',
		descriptionKey: 'routes/apps/chain-tools/launchpad.tools.coinstarter.description',
