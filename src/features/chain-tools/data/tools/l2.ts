...
export const l2Tools: ExternalTool[] = [
	// ========== Major L2s ==========
	{
		id: 'arbitrum-one',
		name: 'Arbitrum One',
		descriptionKey: 'l2.tools.arbitrum_one.description',
	...
	},
	{
		id: 'optimism',
		name: 'Optimism',
		descriptionKey: 'l2.tools.optimism.description',
	...
	},
	{
		id: 'base',
		name: 'Base',
		descriptionKey: 'l2.tools.base.description',
		url: 'https://base.org',
		icon: Hexagon,
		category: 'l2',
	...
	// ========== ZK Rollups ==========
	{
		id: 'zksync-era',
		name: 'zkSync Era',
		descriptionKey: 'l2.tools.zksync_era.description',
		url: 'https://zksync.io',
		icon: Layers2,
		category: 'l2',
	...
	},
	{
		id: 'starknet',
		name: 'Starknet',
		descriptionKey: 'l2.tools.starknet.description',
	...
	},
	{
		id: 'scroll',
		name: 'Scroll',
		descriptionKey: 'l2.tools.scroll.description',
		url: 'https://scroll.io',
		icon: Layers2,
		category: 'l2',
	...
	},
	{
		id: 'linea',
		name: 'Linea',
		descriptionKey: 'l2.tools.linea.description',
	...
	},
	{
		id: 'polygon-zkevm',
		name: 'Polygon zkEVM',
		descriptionKey: 'l2.tools.polygon_zkevm.description',
	...
	},
	{
		id: 'taiko-l2',
		name: 'Taiko',
		descriptionKey: 'l2.tools.taiko_l2.description',
		url: 'https://taiko.xyz',
		icon: Layers2,
		category: 'l2',
	...
	// ========== Optimistic L2s ==========
	{
		id: 'manta-pacific',
		name: 'Manta Pacific',
		descriptionKey: 'l2.tools.manta_pacific.description',
	...
	},
	{
		id: 'blast-l2',
		name: 'Blast',
		descriptionKey: 'l2.tools.blast_l2.description',
		url: 'https://blast.io',
		icon: Zap,
		category: 'l2',
	...
	},
	{
		id: 'mode',
		name: 'Mode',
		descriptionKey: 'l2.tools.mode.description',
	...
	},
	{
		id: 'mantle',
		name: 'Mantle',
		descriptionKey: 'l2.tools.mantle.description',
	...
	// ========== New L2s ==========
	{
		id: 'megaeth-l2',
		name: 'MegaETH',
		descriptionKey: 'l2.tools.megaeth_l2.description',
	...
	},
	{
		id: 'eclipse-l2',
		name: 'Eclipse',
		descriptionKey: 'l2.tools.eclipse_l2.description',
	...
	},
	{
		id: 'fuel-l2',
		name: 'Fuel',
		descriptionKey: 'l2.tools.fuel_l2.description',
	...
	},
	{
		id: 'kinto-l2',
		name: 'Kinto',
		descriptionKey: 'l2.tools.kinto_l2.description',
		url: 'https://kinto.xyz',
		icon: Layers2,
		category: 'l2',
	...
	},
	{
		id: 'morph-l2',
		name: 'Morph',
		descriptionKey: 'l2.tools.morph_l2.description',
	...
	},
	{
		id: 'bob-l2',
		name: 'BOB',
		descriptionKey: 'l2.tools.bob_l2.description',
		url: 'https://gobob.xyz',
		icon: Layers2,
		category: 'l2',
	...
	},
	{
		id: 'metal-l2',
		name: 'Metal L2',
		descriptionKey: 'l2.tools.metal_l2.description',
	...
	},
	{
		id: 'cyber-l2',
		name: 'Cyber',
		descriptionKey: 'l2.tools.cyber_l2.description',
		url: 'https://cyber.co',
		icon: Layers2,
		category: 'l2',
	...
	},
	{
		id: 'fraxtal-l2',
		name: 'Fraxtal',
		descriptionKey: 'l2.tools.fraxtal_l2.description',
	...
	// ========== L2 Frameworks ==========
	{
		id: 'op-stack',
		name: 'OP Stack',
		descriptionKey: 'l2.tools.op_stack.description',
	...
	},
	{
		id: 'orbit-chain',
		name: 'Arbitrum Orbit',
		descriptionKey: 'l2.tools.orbit_chain.description',
	...
	},
	{
		id: 'polygon-cdk',
		name: 'Polygon CDK',
		descriptionKey: 'l2.tools.polygon_cdk.description',
	...
	},
	{
		id: 'zk-stack',
		name: 'ZK Stack',
		descriptionKey: 'l2.tools.zk_stack.description',
	...
	// ========== L2 Analytics ==========
	{
		id: 'l2-marathon',
		name: 'L2 Marathon',
		descriptionKey: 'l2.tools.l2_marathon.description',
	...
	},
	{
		id: 'chainlist-l2',
		name: 'Chainlist',
		descriptionKey: 'l2.tools.chainlist_l2.description',
	...
	// ========== Additional L2 Tools ==========
	{
		id: 'zora-l2',
		name: 'Zora',
		descriptionKey: 'l2.tools.zora_l2.description',
		url: 'https://zora.co',
		icon: Layers2,
		category: 'l2',
	...
	},
	{
		id: 'redstone-l2',
		name: 'Redstone',
		descriptionKey: 'l2.tools.redstone_l2.description',
	...
	},
	{
		id: 'mint-l2',
		name: 'Mint',
		descriptionKey: 'l2.tools.mint_l2.description',
	...
	},
	{
		id: 'ancient8-l2',
		name: 'Ancient8',
		descriptionKey: 'l2.tools.ancient8_l2.description',
	...
	},
	{
		id: 'degen-l3',
		name: 'Degen Chain',
		descriptionKey: 'l2.tools.degen_l3.description',
	...
	},
	{
		id: 'l2beat',
		name: 'L2BEAT',
		descriptionKey: 'l2.tools.l2beat.description',
	...
	},
	{
		id: 'superchain',
		name: 'Superchain',
		descriptionKey: 'l2.tools.superchain.description',
	...
	},
	{
		id: 'world-chain',
		name: 'World Chain',
		descriptionKey: 'l2.tools.world_chain.description',
	...
	},
	{
		id: 'lisk-l2',
		name: 'Lisk',
		descriptionKey: 'l2.tools.lisk_l2.description',
		url: 'https://lisk.com',
		icon: Layers2,
		category: 'l2',
	...
	},
	{
		id: 'ink-l2',
		name: 'Ink',
		descriptionKey: 'l2.tools.ink_l2.description',
