...
export const privacyTools: ExternalTool[] = [
	...
	},
	{
		id: 'monero',
		name: 'Monero',
		descriptionKey: 'chain-tools.tools.monero.description',
	...
	},
	{
		id: 'secret-network',
		name: 'Secret Network',
		descriptionKey: 'chain-tools.tools.secret_network.description',
	...
	},
	{
		id: 'oasis-network',
		name: 'Oasis Network',
		descriptionKey: 'chain-tools.tools.oasis_network.description',
	...
	},
	{
		id: 'mina-protocol',
		name: 'Mina Protocol',
		descriptionKey: 'chain-tools.tools.mina_protocol.description',
	...
	},
	{
		id: 'firo',
		name: 'Firo',
		descriptionKey: 'chain-tools.tools.firo.description',
		url: 'https://firo.org',
		icon: Lock,
		category: 'privacy',
	...
	},
	{
		id: 'iron-fish',
		name: 'Iron Fish',
		descriptionKey: 'chain-tools.tools.iron_fish.description',
	...
	// ========== Privacy Protocols ==========
	{
		id: 'aztec-connect',
		name: 'Aztec',
		descriptionKey: 'chain-tools.tools.aztec_connect.description',
	...
	},
	{
		id: 'umbra-cash',
		name: 'Umbra',
		descriptionKey: 'chain-tools.tools.umbra_cash.description',
	...
	},
	{
		id: 'penumbra',
		name: 'Penumbra',
		descriptionKey: 'chain-tools.tools.penumbra.description',
	...
	},
	{
		id: 'namada',
		name: 'Namada',
		descriptionKey: 'chain-tools.tools.namada.description',
	...
	// ========== Privacy Wallets ==========
	{
		id: 'frame-privacy',
		name: 'Frame',
		descriptionKey: 'chain-tools.tools.frame_privacy.description',
		url: 'https://frame.sh',
		icon: Wallet,
		category: 'privacy',
	...
	},
	{
		id: 'cake-wallet',
		name: 'Cake Wallet',
		descriptionKey: 'chain-tools.tools.cake_wallet.description',
	...
	// ========== ZK Tools ==========
	{
		...
		name: 'Privacy Pools',
		descriptionKey: 'chain-tools.tools.privacy_pools.description',
	...
	},
	{
		id: 'zk-email',
		name: 'ZK Email',
		descriptionKey: 'chain-tools.tools.zk_email.description',
	...
	},
	{
		id: 'semaphore',
		name: 'Semaphore',
		descriptionKey: 'chain-tools.tools.semaphore.description',
	...
	},
	{
		...
		name: 'World ID',
		descriptionKey: 'chain-tools.tools.worldcoin_privacy.description',
