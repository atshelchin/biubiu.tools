...
export const nftTools: ExternalTool[] = [
	// ========== Major Marketplaces ==========
	{
		id: 'opensea',
		name: 'OpenSea',
		descriptionKey: 'chain-tools.nft.tools.opensea.description',
	...
	},
	{
		id: 'blur',
		name: 'Blur',
		descriptionKey: 'chain-tools.nft.tools.blur.description',
		url: 'https://blur.io',
		icon: Image,
		category: 'nft',
	...
	},
	{
		id: 'reservoir',
		name: 'Reservoir',
		descriptionKey: 'chain-tools.nft.tools.reservoir.description',
	...
	},
	{
		id: 'magic-eden',
		name: 'Magic Eden',
		descriptionKey: 'chain-tools.nft.tools.magic_eden.description',
	...
	},
	{
		id: 'rarible',
		name: 'Rarible',
		descriptionKey: 'chain-tools.nft.tools.rarible.description',
	...
	},
	{
		id: 'zora',
		name: 'Zora',
		descriptionKey: 'chain-tools.nft.tools.zora.description',
		url: 'https://zora.co',
		icon: Image,
		category: 'nft',
	...
	},
	{
		id: 'foundation',
		name: 'Foundation',
		descriptionKey: 'chain-tools.nft.tools.foundation.description',
	...
	// ========== Music & Media NFTs ==========
	{
		id: 'sound-xyz',
		name: 'Sound.xyz',
		descriptionKey: 'chain-tools.nft.tools.sound_xyz.description',
	...
	// ========== Creator Tools ==========
	{
		id: 'manifold',
		name: 'Manifold',
		descriptionKey: 'chain-tools.nft.tools.manifold.description',
	...
	// ========== Analytics ==========
	{
		id: 'icy-tools',
		name: 'icy.tools',
		descriptionKey: 'chain-tools.nft.tools.icy_tools.description',
		url: 'https://icy.tools',
		icon: Activity,
		category: 'nft',
	...
	},
	{
		id: 'nftnerds',
		name: 'NFTNerds',
		descriptionKey: 'chain-tools.nft.tools.nftnerds.description',
	...
	// ========== NFT-Fi ==========
	{
		id: 'sudoswap',
		name: 'Sudoswap',
		descriptionKey: 'chain-tools.nft.tools.sudoswap.description',
	...
	},
	{
		id: 'caviar',
		name: 'Caviar',
		descriptionKey: 'chain-tools.nft.tools.caviar.description',
	...
	},
	{
		id: 'nftx',
		name: 'NFTX',
		descriptionKey: 'chain-tools.nft.tools.nftx.description',
		url: 'https://nftx.io',
		icon: Image,
		category: 'nft',
	...
	},
	{
		id: 'floor-protocol',
		name: 'Floor Protocol',
		descriptionKey: 'chain-tools.nft.tools.floor_protocol.description',
	...
	},
	{
		id: 'tessera',
		name: 'Tessera',
		descriptionKey: 'chain-tools.nft.tools.tessera.description',
	...
	// ========== NFT Lending ==========
	{
		id: 'nftfi',
		name: 'NFTfi',
		descriptionKey: 'chain-tools.nft.tools.nftfi.description',
		url: 'https://nftfi.com',
		icon: Banknote,
		category: 'nft',
	...
	},
	{
		id: 'arcade',
		name: 'Arcade',
		descriptionKey: 'chain-tools.nft.tools.arcade.description',
	...
	},
	{
		id: 'unlockd',
		name: 'Unlockd',
		descriptionKey: 'chain-tools.nft.tools.unlockd.description',
	...
	// ========== Launch & Allowlist ==========
	{
		id: 'premint',
		name: 'PREMINT',
		descriptionKey: 'chain-tools.nft.tools.premint.description',
	...
	},
	{
		id: 'mintfun',
		name: 'mint.fun',
		descriptionKey: 'chain-tools.nft.tools.mintfun.description',
		url: 'https://mint.fun',
		icon: Sparkles,
		category: 'nft',
	...
	// ========== Creator Tools Extended ==========
	{
		id: 'bueno',
		name: 'Bueno',
		descriptionKey: 'chain-tools.nft.tools.bueno.description',
		url: 'https://bueno.art',
		icon: Image,
		category: 'nft',
	...
	},
	{
		id: 'highlight',
		name: 'Highlight',
		descriptionKey: 'chain-tools.nft.tools.highlight.description',
	...
	},
	{
		id: 'transient-labs',
		name: 'Transient Labs',
		descriptionKey: 'chain-tools.nft.tools.transient_labs.description',
	...
	},
	{
		id: 'decent-xyz',
		name: 'Decent',
		descriptionKey: 'chain-tools.nft.tools.decent_xyz.description',
	...
	// ========== Utilities ==========
	{
		id: 'tokenproof',
		name: 'Tokenproof',
		descriptionKey: 'chain-tools.nft.tools.tokenproof.description',
	...
	},
	{
		id: 'delegate-cash',
		name: 'Delegate.cash',
		descriptionKey: 'chain-tools.nft.tools.delegate_cash.description',
	...
	},
	{
		id: 'warm-xyz',
		name: 'Warm.xyz',
		descriptionKey: 'chain-tools.nft.tools.warm_xyz.description',
		url: 'https://warm.xyz',
		icon: Link2,
		category: 'nft',
	...
	// ========== Quest & Learn ==========
	{
		id: 'layer3-quests',
		name: 'Layer3',
		descriptionKey: 'chain-tools.nft.tools.layer3_quests.description',
	...
	},
	{
		id: 'rabbithole',
		name: 'RabbitHole',
		descriptionKey: 'chain-tools.nft.tools.rabbithole.description',
	...
	// ========== Solana & Other Chains ==========
	{
		id: 'tensor',
		name: 'Tensor',
		descriptionKey: 'chain-tools.nft.tools.tensor.description',
	...
	},
	{
		id: 'hyperspace',
		name: 'Hyperspace',
		descriptionKey: 'chain-tools.nft.tools.hyperspace.description',
	...
	},
	{
		id: 'tradeport',
		name: 'Tradeport',
		descriptionKey: 'chain-tools.nft.tools.tradeport.description',
	...
	},
	{
		id: 'campfire',
		name: 'Campfire',
		descriptionKey: 'chain-tools.nft.tools.campfire.description',
	...
	},
	{
		id: 'paintswap',
		name: 'PaintSwap',
		descriptionKey: 'chain-tools.nft.tools.paintswap.description',
	...
	// ========== Ordinals & Bitcoin ==========
	{
		...
		descriptionKey: 'chain-tools.nft.tools.ordinals_market.description',
	...
	},
	{
		...
		descriptionKey: 'chain-tools.nft.tools.magic_eden_ordinals.description',
	...
	// ========== Art Platforms ==========
	{
		id: 'exchange-art',
		name: 'Exchange Art',
		descriptionKey: 'chain-tools.nft.tools.exchange_art.description',
	...
	},
	{
		id: 'formfunction',
		name: 'Formfunction',
		descriptionKey: 'chain-tools.nft.tools.formfunction.description',
	...
	},
	{
		id: 'jpg-store',
		name: 'JPG Store',
		descriptionKey: 'chain-tools.nft.tools.jpg_store.description',
		url: 'https://jpg.store',
		icon: Image,
		category: 'nft',
	...
	// ========== Galleries & Display ==========
	{
		id: 'oncyber',
		name: 'Oncyber',
		descriptionKey: 'chain-tools.nft.tools.oncyber.description',
	...
	// ========== Trading & Aggregation ==========
	{
		id: 'nft-trader',
		name: 'NFT Trader',
		descriptionKey: 'chain-tools.nft.tools.nft_trader.description',
	...
	},
	{
		id: 'looksrare',
		name: 'LooksRare',
		descriptionKey: 'chain-tools.nft.tools.looksrare.description',
	...
	},
	{
		id: 'x2y2',
		name: 'X2Y2',
		descriptionKey: 'chain-tools.nft.tools.x2y2.description',
		url: 'https://x2y2.io',
		icon: Image,
		category: 'nft',
	...
	},
	{
		...
		descriptionKey: 'chain-tools.nft.tools.gem.description',
	...
	// ========== Community & Engagement ==========
	{
		id: 'snag-solutions',
		name: 'Snag Solutions',
		descriptionKey: 'chain-tools.nft.tools.snag_solutions.description',
	...
	},
	{
		...
		descriptionKey: 'chain-tools.nft.tools.icy_marketplace.description',
		url: 'https://icy.tools',
		icon: Image,
		category: 'nft',
