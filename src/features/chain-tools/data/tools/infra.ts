...
export const infraTools: ExternalTool[] = [
	...
	// ========== Solana RPC Providers ==========
	{
		id: 'helius-rpc',
		name: 'Helius',
		descriptionKey: 'chain_tools.tools.helius_rpc.description',
	...
	},
	{
		id: 'triton-rpc',
		name: 'Triton',
		descriptionKey: 'chain_tools.tools.triton_rpc.description',
	...
	},
	{
		id: 'syndica-rpc',
		name: 'Syndica',
		descriptionKey: 'chain_tools.tools.syndica_rpc.description',
	...
	// ========== Multi-chain RPC ==========
	{
		id: 'lava-network',
		name: 'Lava Network',
		descriptionKey: 'chain_tools.tools.lava_network.description',
	...
	},
	{
		id: 'erpc-network',
		name: 'eRPC',
		descriptionKey: 'chain_tools.tools.erpc_network.description',
	...
	},
	{
		id: 'thirdweb-rpc',
		name: 'thirdweb RPC',
		descriptionKey: 'chain_tools.tools.thirdweb_rpc.description',
	...
	},
	{
		id: 'tatum-rpc',
		name: 'Tatum',
		descriptionKey: 'chain_tools.tools.tatum_rpc.description',
		url: 'https://tatum.io',
		icon: Server,
		category: 'infra',
	...
	},
	{
		id: 'chainstack-rpc',
		name: 'Chainstack',
		descriptionKey: 'chain_tools.tools.chainstack_rpc.description',
		url: 'https://chainstack.com',
		icon: Server,
		category: 'infra',
	...
	},
	{
		id: 'blockpi',
		name: 'BlockPI',
		descriptionKey: 'chain_tools.tools.blockpi.description',
	...
	},
	{
		id: 'nodereal',
		name: 'NodeReal',
		descriptionKey: 'chain_tools.tools.nodereal.description',
