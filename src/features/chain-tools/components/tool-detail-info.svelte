...
{#if hasProjectInfo || hasSocialLinks}
	<section class="info-section">
		<h2 class="section-title">
			...
			<span
				>{i18n.t('chain-tools.project_info' as keyof TranslationKeys, {
				...
				<div class="info-grid">
						...
						<div class="info-item">
							...
							<div class="info-content">
								<span class="info-label"
									>{i18n.t('chain-tools.founded' as keyof TranslationKeys, {
					...
					{#if detail.team}
						<div class="info-item">
							...
							<div class="info-content">
								<span class="info-label"
									>{i18n.t('chain-tools.team' as keyof TranslationKeys, {
										defaultValue: 'Team'
									})}</span
								>
					...
					{#if detail.funding}
						<div class="info-item">
							...
							<div class="info-content">
								<span class="info-label"
									>{i18n.t('chain-tools.funding' as keyof TranslationKeys, {
			...
			{#if hasSocialLinks && detail.socialLinks}
				<div class="social-section">
					<span class="social-label"
						>{i18n.t('chain-tools.links' as keyof TranslationKeys, {
							defaultValue: 'Links'
						})}:</span
					>
