...
<div class="progress-card" transition:slide>
	<h4>
		{#if progress.phase === 'preparing'}
			{i18n.t('routes/apps/wallet-sweep.step5.content.progress.preparing')}
		{:else if progress.phase === 'building'}
			{i18n.t('routes/apps/wallet-sweep.step5.content.progress.building')}
		{:else if progress.phase === 'executing'}
			{i18n.t('routes/apps/wallet-sweep.step5.content.progress.executing')}
		{:else if progress.phase === 'confirming'}
			{i18n.t('routes/apps/wallet-sweep.step5.content.progress.confirming')}
		{:else if progress.phase === 'completed'}
			{i18n.t('routes/apps/wallet-sweep.step5.content.progress.completed')}
		{:else if progress.phase === 'error'}
			{i18n.t('routes/apps/wallet-sweep.step5.content.progress.error')}
		{/if}
	</h4>
	...
	<div class="progress-stats">
		<span
			>{i18n.t('routes/apps/wallet-sweep.step5.content.progress.batch', {
				current: progress.currentBatch,
				total: progress.totalBatches
			})}</span
		>
		<span
			>{i18n.t('routes/apps/wallet-sweep.step5.content.progress.wallet', {
	...
	{#if progress.results.length > 0}
		<div class="progress-results">
			<h5>
				{i18n.t('routes/apps/wallet-sweep.step5.content.progress.results', {
