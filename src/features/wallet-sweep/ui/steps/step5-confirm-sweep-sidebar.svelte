...
<StepSidebar stepNumber={5} title="" description="">
	<StepSummary title={i18n.t('routes/apps/wallet-sweep.step5.sidebar.summary_title')}>
		<div class="summary-item">
			<span>{i18n.t('routes/apps/wallet-sweep.step5.sidebar.selected_tokens')}</span>
			<strong>{selectedTokenCount}</strong>
		</div>
		<div class="summary-item">
			<span>{i18n.t('routes/apps/wallet-sweep.step5.sidebar.total_wallets')}</span>
	...
	{#if tokenStatsWithBatch.length > 0}
		<div class="token-stats" transition:fade>
			<h4 class="token-stats-title">
				{i18n.t('routes/apps/wallet-sweep.step4.sidebar.token_stats.title')}
			</h4>
					...
					<div class="token-stat-header">
						<div class="token-info">
							...
							<span class="address-count">
								{i18n.t('routes/apps/wallet-sweep.step4.sidebar.token_stats.wallets_count', {
						...
						<span class="batch-info">
							{stat.batchCount}
							{i18n.t('routes/apps/wallet-sweep.step5.sidebar.batches')}
						</span>
					</div>
