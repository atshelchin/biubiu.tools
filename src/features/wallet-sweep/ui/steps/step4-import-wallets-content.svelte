<script lang="ts">
	...
	import { useWalletGeneration } from '@/features/wallet-sweep/composables/use-wallet-generation.svelte';
	...
	import type { ImportMethod, DerivationPathType } from '@/features/wallet-sweep/types/wallet';
