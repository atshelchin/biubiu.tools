	...
	<div class="form-container">
		...
		<div class="form-group">
			...
			<input
				...
				maxlength="50"
			/>
			<p class="form-hint">{i18n.t('routes/apps/nft-deployer.step3.content.name_hint')}</p>
		</div>
		...
		<div class="form-group">
			...
			/>
			<p class="form-hint">{i18n.t('routes/apps/nft-deployer.step3.content.symbol_hint')}</p>
		</div>

		<!-- Mint Type Selection (Radio buttons - must choose one) -->
		<fieldset class="form-group">
			<legend class="form-label">
				{i18n.t('routes/apps/nft-deployer.step3.content.mint_type_label')}
				<span class="required">*</span>
			</legend>
			<div class="radio-group">
				<label class="radio-label">
					...
					<span class="radio-text">
						<strong>{i18n.t('routes/apps/nft-deployer.step3.content.public_mint_enabled')}</strong>
						<span class="radio-description">
							{i18n.t('routes/apps/nft-deployer.step3.content.public_mint_hint')}
						</span>
					</span>
				</label>
				...
				<label class="radio-label">
					...
					/>
					<span class="radio-text">
						<strong>{i18n.t('routes/apps/nft-deployer.step3.content.enable_stake_to_mint')}</strong>
						<span class="radio-description">
							{i18n.t('routes/apps/nft-deployer.step3.content.stake_to_mint_hint')}
						</span>
					</span>
				</label>
			</div>
		...
		{#if step3NFTConfigState.stakeToMintEnabled}
			<div class="form-group conditional">
				<label for="stake-token" class="form-label">
					{i18n.t('routes/apps/nft-deployer.step3.content.stake_token_label')}
					<span class="required">*</span>
				</label>
				<input
					id="stake-token"
				...
				/>
				<p class="form-hint">{i18n.t('routes/apps/nft-deployer.step3.content.stake_token_hint')}</p>
			</div>

			<div class="form-group conditional">
				<label for="stake-amount" class="form-label">
					{i18n.t('routes/apps/nft-deployer.step3.content.stake_amount_label')}
					<span class="required">*</span>
				</label>
				<input
					id="stake-amount"
				...
				/>
				<p class="form-hint">
					{i18n.t('routes/apps/nft-deployer.step3.content.stake_amount_hint')}
				</p>
			</div>
		{/if}
		...
		{#if step3NFTConfigState.name && step3NFTConfigState.symbol}
			<div class="preview-box">
				<h4>{i18n.t('routes/apps/nft-deployer.step3.content.preview')}</h4>
