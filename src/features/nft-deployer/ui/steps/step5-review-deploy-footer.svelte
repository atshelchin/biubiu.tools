<script lang="ts">
	...
	function handleDone() {
		// Reset all states and go back to start
...
<div class="step-footer">
	...
	{#if deploymentState.isCompleted}
		<button class="footer-button primary" onclick={handleDone}>
			{i18n.t('common.done')}
		</button>
	{:else}
		<button class="footer-button primary" disabled>
