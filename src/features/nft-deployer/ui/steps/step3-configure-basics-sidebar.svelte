...
<div class="step-sidebar">
	<h3 class="sidebar-title">{i18n.t('routes/apps/nft-deployer.step3.sidebar.title')}</h3>
	<p class="sidebar-description">
		{i18n.t('routes/apps/nft-deployer.step3.sidebar.description')}
	</p>

	<div class="progress-section">
		<h4 class="info-title">{i18n.t('routes/apps/nft-deployer.step3.sidebar.progress')}</h4>
		<div class="progress-list">
			<div class="progress-item" class:complete={progress.name}>
				<div class="checkbox">
					{#if progress.name}✓{/if}
				</div>
				<span>{i18n.t('routes/apps/nft-deployer.step3.sidebar.field_name')}</span>
			</div>
			<div class="progress-item" class:complete={progress.symbol}>
				<div class="checkbox">
					{#if progress.symbol}✓{/if}
				</div>
				<span>{i18n.t('routes/apps/nft-deployer.step3.sidebar.field_symbol')}</span>
			</div>
			<div class="progress-item" class:complete={progress.description}>
				<div class="checkbox">
					{#if progress.description}✓{/if}
				</div>
				<span>{i18n.t('routes/apps/nft-deployer.step3.sidebar.field_description')}</span>
			</div>
			<div class="progress-item optional" class:complete={progress.baseUri}>
				<div class="checkbox">
					{#if progress.baseUri}✓{/if}
				</div>
				<span>{i18n.t('routes/apps/nft-deployer.step3.sidebar.field_base_uri')}</span>
			</div>
		</div>
	</div>
	...
	{#if requiredComplete}
		<div class="complete-message">
			...
			<span>{i18n.t('routes/apps/nft-deployer.step3.sidebar.all_required_complete')}</span>
		</div>
	{/if}

	<div class="info-section">
		<h4 class="info-title">{i18n.t('routes/apps/nft-deployer.step3.sidebar.tips')}</h4>
		<ul class="info-list">
			<li>{i18n.t('routes/apps/nft-deployer.step3.sidebar.tip1')}</li>
			<li>{i18n.t('routes/apps/nft-deployer.step3.sidebar.tip2')}</li>
			<li>{i18n.t('routes/apps/nft-deployer.step3.sidebar.tip3')}</li>
		</ul>
	</div>
</div>
