...
<div class="step-content">
	<StepContentHeader
		...
		description="Choose the blockchain network for event scanning"
	/>
		...
		{#if isReadyToContinue}
			<div class="continue-section">
				<button class="continue-button" onclick={handleContinue}>
					<span>Continue to Contract Configuration</span>
					<svg
						width="20"
						height="20"
						viewBox="0 0 24 24"
				...
				<p class="continue-hint">
					Your wallet is connected and ready. Click to proceed with contract configuration.
				</p>
			</div>
		{/if}
	{/if}
