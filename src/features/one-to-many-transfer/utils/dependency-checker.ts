/**
 * Token-distribution dependency checker
...
/**
 * Run all dependency checks for token-distribution
 */
export async function checkAllDependencies(
	...
	return runDependencyChecks(getPresetConfig('token-distribution'), context);
}
