...
<div class="mode-selector" class:disabled>
	...
	>
		...
		<div class="mode-content">
			<h4 class="mode-title">
				{i18n.t('routes/apps/one-to-many-transfer.step5.mode.self.title')}
			</h4>
			<p class="mode-description">
				{i18n.t('routes/apps/one-to-many-transfer.step5.mode.self.description')}
			</p>
		</div>
	...
	>
		...
		<div class="mode-content">
			<h4 class="mode-title">
				{i18n.t('routes/apps/one-to-many-transfer.step5.mode.delegated.title')}
			</h4>
			<p class="mode-description">
				{i18n.t('routes/apps/one-to-many-transfer.step5.mode.delegated.description')}
			</p>
		</div>
		<div class="mode-indicator">
	...
	{#if value === 'delegated'}
		<div class="info-banner">
			<Info size={16} />
			<span>{i18n.t('routes/apps/one-to-many-transfer.step5.mode.delegated.info')}</span>
		</div>
	{/if}
</div>
